---
title: "Sorting JUM output files and analysing them for the 2019 Rauch BM-MSC series bulk RNA-Seq"
author: "Angel Liang"
date: "10/21/2019"
output: pdf_document
---
...
PSI_levels_timeseries_AD_wide_processed <- PSI_levels_timeseries_AD_wide_processed[, c("Gene", "isoform_ID", "MSC", "4h", "1d", "7d", "14d")]
...
som_5_by_5_ADseries_table  <- PSI_levels_timeseries_AD_wide_processed[, c("MSC", "4h", "1d", "7d", "14d")]
...
ggplot(long_table_of_final_SOM_summary_5_by_5_ADseries, aes(x = timepoint, y = scaled_PSI_value)) +
  ...
  scale_x_discrete(limits = c('MSC', '4h', '1d', '7d', '14d')) +
  xlab("Time-point") +
 ...
 ggsave(filename = paste(results_directory_soms, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".pdf", sep = ""), device = "pdf", dpi = 600, width = 33, height = 20, units = "cm") +
 ggsave(filename = paste(results_directory_soms, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".svg", sep = ""), device = "svg", dpi = 600, width = 33, height = 20, units = "cm")

write.table(x = long_table_of_final_SOM_summary_5_by_5_ADseries, file = paste(results_directory_soms, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
ggplot(long_table_of_final_SOM_summary_5_by_5_OBseries, aes(x = timepoint, y = scaled_PSI_value)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1), legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_soms, OB_xdim, "x", OB_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_OBseries), "_isoforms_PSI_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".pdf", sep = ""), device = "pdf", dpi = 600, width = 33, height = 20, units = "cm") +
 ggsave(filename = paste(results_directory_soms, OB_xdim, "x", OB_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_OBseries), "_isoforms_PSI_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".svg", sep = ""), device = "svg", dpi = 600, width = 33, height = 20, units = "cm")

write.table(x = long_table_of_final_SOM_summary_5_by_5_OBseries, file = paste(results_directory_soms, OB_xdim, "x", OB_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_OBseries), "_isoforms_PSI_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
### PREPARATION OF GENE BACKGROUND
...
all_human_genes_GO_background <- getBM(filters = "chromosome_name", values = c(1:22, "X", "Y"), attributes = c("external_gene_name", "transcript_biotype"), mart = ensembl_mart)

# NOTE: filtering was really dodgy and janky :E

all_human_genes_GO_background <- all_human_genes_GO_background[all_human_genes_GO_background$transcript_biotype == "protein_coding" | all_human_genes_GO_background$transcript_biotype == "long_noncoding" | all_human_genes_GO_background$transcript_biotype == "transcribed_processed_pseudogene" | all_human_genes_GO_background$transcript_biotype == "transcribed_unitary_pseudogene" | all_human_genes_GO_background$transcript_biotype == "transcribed_unprocessed_pseudogene" | all_human_genes_GO_background$transcript_biotype == "translated_processed_pseudogene", ]
...
wide_table_of_all_splicemodes_with_na_OBseries_filtered_qvalue_0.05$Gene %>% unique %>% length %>% paste(., "unique genes differentially spliced between any two time points during the time course of osteoblastic differentiation with FDR < 0.05") %>% print
...
wide_table_of_all_splicemodes_with_na_ADseries_filtered_qvalue_0.05$Gene %>% unique %>% length %>% paste(., "unique genes differentially spliced between any two time points during the time course of adipocytic differentiation with FDR < 0.05") %>% print
...
# 
# write.table(x = polyA_RNAseq_GO_background, file = paste(results_dir, "polyA_RNAseq_GO_background.txt", sep = ""), quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t")
# 
...
# 
# catdb <- makeCATdb(myfile = paste(results_dir, "polyA_RNAseq_GO_background.txt", sep = ""), lib = NULL, org = "", colno = c(2, 1, 3), idconv = NULL)
...
OB_anysig_GOtest_MF_2 <- GOHyperGAll(catdb = catdb, gocat = "MF", sample = OBseries_qvalue_0.05_GO_genelist, Nannot = 2) %>% GOHyperGAll_benjamini_correction
...
ggplot(OB_anysig_GOtest_all_topten, aes(x = reorder(Term, Padj), y = SampleMatch)) +
  ...
  ggtitle("Top 10 significantly over-represented GO terms for OB series") +
  xlab("GO term") +
 ...
 ggsave(filename = paste(results_directory_soms, "Top 10 significantly over-represented GO terms for OB series.pdf", sep = ""), device = "pdf", dpi = 600, width = 45, height = 25, units = "cm") +
 ggsave(filename = paste(results_directory_soms, "Top 10 significantly over-represented GO terms for OB series.svg", sep = ""), device = "svg", dpi = 600, width = 45, height = 25, units = "cm")
...
ggplot(AD_anysig_GOtest_all_topten, aes(x = reorder(Term, Padj), y = SampleMatch)) +
  ...
  scale_fill_distiller(name = expression(log["10"](P["b-hoch"])), type = "seq", palette = "Purples", direction = -1,   aesthetics = "fill") +
  facet_grid(~ Ont, scales = "free") +
  ggtitle("Top 10 significantly over-represented GO terms for AD series") +
  xlab("GO term") +
  ylab("Number of genes in GO term") +
  coord_cartesian(ylim = c(0, 50)) +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_soms, "Top 10 significantly over-represented GO terms for AD series.pdf", sep = ""), device = "pdf", dpi = 600, width = 45, height = 25, units = "cm") +
 ggsave(filename = paste(results_directory_soms, "Top 10 significantly over-represented GO terms for AD series.svg", sep = ""), device = "svg", dpi = 600, width = 45, height = 25, units = "cm")
...
ggplot(wide_table_of_topten_hyperGOresult_MF_ADseries_processed, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
 ...
 ggsave(filename = paste(results_directory_soms, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, "_MF_GO.pdf", sep = ""), device = "pdf", dpi = 600, width = 45, height = 25, units = "cm") +
 ggsave(filename = paste(results_directory_soms, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, "_MF_GO.svg", sep = ""), device = "svg", dpi = 600, width = 45, height = 25, units = "cm")

write.table(x = wide_table_of_topten_hyperGOresult_MF_ADseries_processed, file = paste(results_directory_soms, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, "_MF_GO.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
ggplot(wide_table_of_topten_hyperGOresult_BP_ADseries_processed, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), strip.background = element_blank(), strip.text.x = element_blank(), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_soms, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, "_BP_GO.pdf", sep = ""), device = "pdf", dpi = 600, width = 45, height = 25, units = "cm") +
 ggsave(filename = paste(results_directory_soms, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, "_BP_GO.svg", sep = ""), device = "svg", dpi = 600, width = 45, height = 25, units = "cm")

write.table(x = wide_table_of_topten_hyperGOresult_BP_ADseries_processed, file = paste(results_directory_soms, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, "_BP_GO.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
ggplot(wide_table_of_topten_hyperGOresult_CC_ADseries_processed, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), strip.background = element_blank(), strip.text.x = element_blank(), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_soms, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, "_CC_GO.pdf", sep = ""), device = "pdf", dpi = 600, width = 45, height = 25, units = "cm") +
 ggsave(filename = paste(results_directory_soms, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, "_CC_GO.svg", sep = ""), device = "svg", dpi = 600, width = 45, height = 25, units = "cm")

write.table(x = wide_table_of_topten_hyperGOresult_CC_ADseries_processed, file = paste(results_directory_soms, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, "_CC_GO.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
ggplot(wide_table_of_topten_hyperGOresult_MF_OBseries_processed, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), strip.background = element_blank(), strip.text.x = element_blank(), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_soms, OB_xdim, "x", OB_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_OBseries), "_isoforms_PSI_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, "_MF_GO.pdf", sep = ""), device = "pdf", dpi = 600, width = 45, height = 25, units = "cm") +
 ggsave(filename = paste(results_directory_soms, OB_xdim, "x", OB_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_OBseries), "_isoforms_PSI_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, "_MF_GO.svg", sep = ""), device = "svg", dpi = 600, width = 45, height = 25, units = "cm")

write.table(x = wide_table_of_topten_hyperGOresult_MF_OBseries_processed, file = paste(results_directory_soms, OB_xdim, "x", OB_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_OBseries), "_isoforms_PSI_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, "_MF_GO.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
ggplot(wide_table_of_topten_hyperGOresult_BP_OBseries_processed, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), strip.background = element_blank(), strip.text.x = element_blank(), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_soms, OB_xdim, "x", OB_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_OBseries), "_isoforms_PSI_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, "_BP_GO.pdf", sep = ""), device = "pdf", dpi = 600, width = 45, height = 25, units = "cm") +
 ggsave(filename = paste(results_directory_soms, OB_xdim, "x", OB_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_OBseries), "_isoforms_PSI_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, "_BP_GO.svg", sep = ""), device = "svg", dpi = 600, width = 45, height = 25, units = "cm")

write.table(x = wide_table_of_topten_hyperGOresult_BP_OBseries_processed, file = paste(results_directory_soms, OB_xdim, "x", OB_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_OBseries), "_isoforms_PSI_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, "_BP_GO.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
ggplot(wide_table_of_topten_hyperGOresult_CC_OBseries_processed, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), strip.background = element_blank(), strip.text.x = element_blank(), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_soms, OB_xdim, "x", OB_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_OBseries), "_isoforms_PSI_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, "_CC_GO.pdf", sep = ""), device = "pdf", dpi = 600, width = 45, height = 25, units = "cm") +
 ggsave(filename = paste(results_directory_soms, OB_xdim, "x", OB_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_OBseries), "_isoforms_PSI_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, "_CC_GO.svg", sep = ""), device = "svg", dpi = 600, width = 45, height = 25, units = "cm")

write.table(x = wide_table_of_topten_hyperGOresult_CC_OBseries_processed, file = paste(results_directory_soms, OB_xdim, "x", OB_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_OBseries), "_isoforms_PSI_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, "_CC_GO.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
ADseries_timepoints <- c("MSC", "4h", "1d", "7d", "14d")
...
# replace unsignificant values as NA
...
ggplot(wide_table_of_timepointwise_highestPSI_results_MF_ADseries_processed, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
 ...
 ggsave(filename = paste(results_directory_soms, "MF_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".pdf", sep = ""), device = "pdf", dpi = 600, width = 25, height = 15, units = "cm") +
 ggsave(filename = paste(results_directory_soms, "MF_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".svg", sep = ""), device = "svg", dpi = 600, width = 25, height = 15, units = "cm")

write.table(x = wide_table_of_timepointwise_highestPSI_results_MF_ADseries_processed, file = paste(results_directory_soms, "MF_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
ggplot(wide_table_of_timepointwise_highestPSI_results_BP_ADseries_processed, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_soms, "BP_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".pdf", sep = ""), device = "pdf", dpi = 600, width = 25, height = 15, units = "cm") +
 ggsave(filename = paste(results_directory_soms, "BP_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".svg", sep = ""), device = "svg", dpi = 600, width = 25, height = 15, units = "cm")

write.table(x = wide_table_of_timepointwise_highestPSI_results_BP_ADseries_processed, file = paste(results_directory_soms, "BP_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
ggplot(wide_table_of_timepointwise_highestPSI_results_CC_ADseries_processed, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_soms, "CC_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".pdf", sep = ""), device = "pdf", dpi = 600, width = 25, height = 15, units = "cm") +
 ggsave(filename = paste(results_directory_soms, "CC_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".svg", sep = ""), device = "svg", dpi = 600, width = 25, height = 15, units = "cm")

write.table(x = wide_table_of_timepointwise_highestPSI_results_CC_ADseries_processed, file = paste(results_directory_soms, "CC_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_AD_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
ggplot(wide_table_of_timepointwise_highestPSI_results_MF_OBseries_processed, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_soms, "MF_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".pdf", sep = ""), device = "pdf", dpi = 600, width = 25, height = 15, units = "cm") +
 ggsave(filename = paste(results_directory_soms, "MF_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".svg", sep = ""), device = "svg", dpi = 600, width = 25, height = 15, units = "cm")

write.table(x = wide_table_of_timepointwise_highestPSI_results_MF_OBseries_processed, file = paste(results_directory_soms, "MF_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
ggplot(wide_table_of_timepointwise_highestPSI_results_BP_OBseries_processed, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_soms, "BP_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".pdf", sep = ""), device = "pdf", dpi = 600, width = 25, height = 15, units = "cm") +
 ggsave(filename = paste(results_directory_soms, "BP_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".svg", sep = ""), device = "svg", dpi = 600, width = 25, height = 15, units = "cm")

write.table(x = wide_table_of_timepointwise_highestPSI_results_BP_OBseries_processed, file = paste(results_directory_soms, "BP_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
ggplot(wide_table_of_timepointwise_highestPSI_results_CC_OBseries_processed, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_soms, "CC_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".pdf", sep = ""), device = "pdf", dpi = 600, width = 25, height = 15, units = "cm") +
 ggsave(filename = paste(results_directory_soms, "CC_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".svg", sep = ""), device = "svg", dpi = 600, width = 25, height = 15, units = "cm")

write.table(x = wide_table_of_timepointwise_highestPSI_results_CC_OBseries_processed, file = paste(results_directory_soms, "CC_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_OB_diff_any_pvalue_any_deltaPSI_greaterthan_", dPSI_cutoff, ".txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
