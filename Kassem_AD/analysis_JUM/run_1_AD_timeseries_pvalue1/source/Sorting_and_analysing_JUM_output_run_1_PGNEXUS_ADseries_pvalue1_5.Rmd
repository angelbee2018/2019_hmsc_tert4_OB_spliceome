...
write.table(x = wide_table_of_timepointwise_lowestPSI_results_MF_ADseries_processed, file = paste(results_directory_figures, "MF_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_AD_diff_any_", p_or_q_value, "_any_deltaPSI_greaterthan_", dPSI_cutoff, ".txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
write.table(x = wide_table_of_timepointwise_lowestPSI_results_BP_ADseries_processed, file = paste(results_directory_figures, "BP_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_AD_diff_any_", p_or_q_value, "_any_deltaPSI_greaterthan_", dPSI_cutoff, ".txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
write.table(x = wide_table_of_timepointwise_lowestPSI_results_CC_ADseries_processed, file = paste(results_directory_figures, "CC_GOterms_top10_", high_scaledPSIcutoff * 100, "_percent_eachtimepoint_AD_diff_any_", p_or_q_value, "_any_deltaPSI_greaterthan_", dPSI_cutoff, ".txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
JUM_diff_dir <- "Y:/PGNEXUS_ADseries/analysis_JUM/run_1_AD_timeseries_pvalue1/intermediate_files/JUM_diff/"
