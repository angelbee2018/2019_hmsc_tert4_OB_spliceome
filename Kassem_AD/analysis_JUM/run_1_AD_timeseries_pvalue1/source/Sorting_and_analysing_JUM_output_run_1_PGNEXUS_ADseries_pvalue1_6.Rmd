...
JUM_diff_dir <- "Y:/PGNEXUS_ADseries/analysis_JUM/run_1_AD_timeseries_pvalue1/results/JUM_diff/"
...
ggplot(PCA_loadings) + 
  ...
  theme_bw() +
  theme(text = element_text(family = "Helvetica")) +
  ggsave(filename = paste(qualitycheck_results_dir, "PCA_plot_based_on_JUM_combined_count.pdf", sep = ""), device = "pdf", dpi = 600, width = 45, height = 25, units = "cm") +
  ggsave(filename = paste(qualitycheck_results_dir, "PCA_plot_based_on_JUM_combined_count.svg", sep = ""), device = "svg", dpi = 600, width = 45, height = 25, units = "cm")
...
tibble_ssd_RUV_wide_RLE[, 2:ncol(tibble_ssd_RUV_wide_RLE)] <- transformRLE(tibble_ssd_RUV_wide_RLE[, 2:ncol(tibble_ssd_RUV_wide_RLE)])
...
ggplot(PCA_loadings_filtered) + 
  ...
  theme_bw() +
  theme(text = element_text(family = "Helvetica")) +
  ggsave(filename = paste(qualitycheck_results_dir, "PCA_plot_PC3_vs_PC2_based_on_JUM_combined_count_filtered_RUV.pdf", sep = ""), device = "pdf", dpi = 600, width = 45, height = 25, units = "cm") +
  ggsave(filename = paste(qualitycheck_results_dir, "PCA_plot_PC3_vs_PC2_based_on_JUM_combined_count_filtered_RUV.svg", sep = ""), device = "svg", dpi = 600, width = 45, height = 25, units = "cm")
