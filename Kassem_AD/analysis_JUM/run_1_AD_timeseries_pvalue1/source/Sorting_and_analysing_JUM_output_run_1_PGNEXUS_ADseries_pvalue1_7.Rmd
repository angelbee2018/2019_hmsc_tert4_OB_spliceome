...
list_genes_or_isoforms_from_combinedexpr_cooccuring <- purrr::map(.x = list_genes_or_isoforms_from_combinedexpr, .f = ~tibble_consensus_matrix_combinedexpr_long[tibble_consensus_matrix_combinedexpr_long$variable == .x & tibble_consensus_matrix_combinedexpr_long$cocluster_percentage >= 0.2, "gene_isoform_ID"])
...
plot(density(list_genes_or_isoforms_from_combinedexpr_itemwise_intersection_2$coclustering_intersection %>% as.numeric))
...
cytoscape_result <- read_delim(paste(results_directory_figures, "intersection100_penalty2_haircut0_multi_match_overlap0.8_seedeverynode.tab", sep = ""), delim = "\t", col)

colnames(cytoscape_result) <- cytoscape_result
