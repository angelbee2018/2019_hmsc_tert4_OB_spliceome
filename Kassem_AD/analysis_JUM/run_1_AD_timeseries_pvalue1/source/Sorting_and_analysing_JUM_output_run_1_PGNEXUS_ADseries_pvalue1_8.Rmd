...
results_dir <- "//VBOXSVR/sharedfolder/PGNEXUS_kassem_MSC/Kassem_AD_fastqc/analysis_JUM/run_1_AD_timeseries_pvalue1/results/"
...
# wide_table_of_all_splicemodes_with_na_ADseries <- wide_table_of_all_splicemodes_with_na[, -grep(colnames(wide_table_of_all_splicemodes_with_na), pattern = "AD")]
...
# 
# numberofgenes_anysig_ADseries %>% paste(., "unique genes differentially spliced between any two time points during the time course of osteoblastic differentiation with FDR < 0.05") %>% print
...
# AD series
# 
# AD_anysig_GOtest_MF <- GOHyperGAll(catdb = catdb, gocat = "protein family", sample = ADseries_qvalue_0.05_GO_genelist, Nannot = 2) %>% GOHyperGAll_benjamini_correction
# 
...
# , wide_table_of_topten_hyperGOresult_MF_ADseries, wide_table_of_topten_hyperGOresult_BP_ADseries, wide_table_of_topten_hyperGOresult_CC_ADseries
...
ggplot(wide_table_of_topten_hyperGOresult_MF_ADseries_processed, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
 ...
 ggsave(filename = paste(results_directory_figures, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_MF_GO.pdf", sep = ""), device = "pdf", dpi = 600, width = 45, height = 25, units = "cm") +
 ggsave(filename = paste(results_directory_figures, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_MF_GO.svg", sep = ""), device = "svg", dpi = 600, width = 45, height = 25, units = "cm")

write.table(x = wide_table_of_topten_hyperGOresult_MF_ADseries_processed, file = paste(results_directory_figures, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_MF_GO.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
ggplot(wide_table_of_topten_hyperGOresult_BP_ADseries_processed, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), strip.background = element_blank(), strip.text.x = element_blank(), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_figures, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_BP_GO.pdf", sep = ""), device = "pdf", dpi = 600, width = 45, height = 25, units = "cm") +
 ggsave(filename = paste(results_directory_figures, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_BP_GO.svg", sep = ""), device = "svg", dpi = 600, width = 45, height = 25, units = "cm")

write.table(x = wide_table_of_topten_hyperGOresult_BP_ADseries_processed, file = paste(results_directory_figures, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_BP_GO.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
ggplot(wide_table_of_topten_hyperGOresult_CC_ADseries_processed, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), strip.background = element_blank(), strip.text.x = element_blank(), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_figures, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_CC_GO.pdf", sep = ""), device = "pdf", dpi = 600, width = 45, height = 25, units = "cm") +
 ggsave(filename = paste(results_directory_figures, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_CC_GO.svg", sep = ""), device = "svg", dpi = 600, width = 45, height = 25, units = "cm")

write.table(x = wide_table_of_topten_hyperGOresult_CC_ADseries_processed, file = paste(results_directory_figures, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_CC_GO.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
names(list_of_familyenrichment_by_SOM_cluster_ADseries) <- 1:(AD_xdim * AD_ydim)
...
bind_rows(., wide_table_of_final_SOM_summary_5_by_5_ADseries %>% .[.$Gene == "HDAC4", ]) %>%
bind_rows(., wide_table_of_final_SOM_summary_5_by_5_ADseries %>% .[.$Gene == "HDAC7", ]) %>%
  bind_rows(., wide_table_of_final_SOM_summary_5_by_5_ADseries %>% .[.$Gene == "HDAC10", ])
...
bind_rows(., wide_table_of_final_SOM_summary_5_by_5_ADseries %>% .[.$Gene == "ATXN1", ]) %>%
bind_rows(., wide_table_of_final_SOM_summary_5_by_5_ADseries %>% .[.$Gene == "ATXN1L", ])
...
bind_rows(., wide_table_of_final_SOM_summary_5_by_5_ADseries %>% .[.$Gene == "PRMT5", ]) %>%
  bind_rows(., wide_table_of_final_SOM_summary_5_by_5_ADseries %>% .[.$Gene == "EFNA5", ]) %>%
  bind_rows(., wide_table_of_final_SOM_summary_5_by_5_ADseries %>% .[.$Gene == "KAT6A", ]) %>%
  bind_rows(., wide_table_of_final_SOM_summary_5_by_5_ADseries %>% .[.$Gene == "KAT2A", ]) %>%
  bind_rows(., wide_table_of_final_SOM_summary_5_by_5_ADseries %>% .[.$Gene == "FBXO5", ]) %>%
  bind_rows(., wide_table_of_final_SOM_summary_5_by_5_ADseries %>% .[.$Gene == "FBXL19", ]) %>%
  bind_rows(., wide_table_of_final_SOM_summary_5_by_5_ADseries %>% .[.$Gene == "DGKE", ]) %>%
  bind_rows(., wide_table_of_final_SOM_summary_5_by_5_ADseries %>% .[.$Gene == "RASSF1", ]) %>%
  bind_rows(., wide_table_of_final_SOM_summary_5_by_5_ADseries %>% .[.$Gene == "EP400", ]) %>%
  bind_rows(., wide_table_of_final_SOM_summary_5_by_5_ADseries %>% .[.$Gene == "HMGN1", ]) %>%
  bind_rows(., wide_table_of_final_SOM_summary_5_by_5_ADseries %>% .[.$Gene == "JNK1", ])
...
interesting_isoforms_2 <- tibble(Gene = c("MMP2", "KATNAL1", "FAT1", "TACC1", "KAT2A", 'CHEK1', "AKT1", "LOXL2", "AURKA", "TCF7L2", "ARHGEF2", "FLRT2", "ENPP2", "KANK1")) %>% dplyr::semi_join(wide_table_of_final_SOM_summary_5_by_5_ADseries, ., by = "Gene") %>% as_tibble %>% mutate_if(is.factor, as.character)
...
CC_focaladhesion_isoforms <- tibble(Gene = c("ANK2", "CACNA2D1", "MDC1", "CASK", "ABI1")) %>% dplyr::semi_join(wide_table_of_final_SOM_summary_5_by_5_ADseries, ., by = "Gene") %>% as_tibble %>% mutate_if(is.factor, as.character)
...
# all cassettes
cassette_isoforms <- wide_table_of_final_SOM_summary_5_by_5_ADseries[wide_table_of_final_SOM_summary_5_by_5_ADseries$splicemode == "cassette_exon", ] %>% as_tibble %>% mutate_if(is.factor, as.character)
...
list_of_ADseries_SOMclusterwise_hyperGOresult_MF_tables_AS_plausible <- purrr::map(.x = list_of_ADseries_gene_tables_by_SOM_cluster_flattened_AS_plausible, .f = ~GOHyperGAll(catdb = catdb, gocat = "MF", Nannot = 2, sample = .x) %>% GOHyperGAll_benjamini_correction)
list_of_ADseries_SOMclusterwise_hyperGOresult_MF_tables_topten_AS_plausible <- purrr::map(.x = list_of_ADseries_SOMclusterwise_hyperGOresult_MF_tables_AS_plausible, ~.[order(.$Padj, decreasing = FALSE), ] %>% head(n = 10))
list_of_ADseries_SOMclusterwise_hyperGOresult_MF_tables_topten_AS_plausible <- purrr::map2(.x = list_of_ADseries_SOMclusterwise_hyperGOresult_MF_tables_topten_AS_plausible, .y = 1:(AD_xdim * AD_ydim), .f = ~cbind(.x, cluster = .y))
# bind rows
wide_table_of_topten_hyperGOresult_MF_ADseries_AS_plausible <- purrr::reduce(.x = list_of_ADseries_SOMclusterwise_hyperGOresult_MF_tables_topten_AS_plausible, .f = bind_rows)
wide_table_of_topten_hyperGOresult_MF_ADseries_AS_plausible <- type_convert(wide_table_of_topten_hyperGOresult_MF_ADseries_AS_plausible)

list_of_ADseries_SOMclusterwise_hyperGOresult_BP_tables_AS_plausible <- purrr::map(.x = list_of_ADseries_gene_tables_by_SOM_cluster_flattened_AS_plausible, .f = ~GOHyperGAll(catdb = catdb, gocat = "BP", Nannot = 2, sample = .x) %>% GOHyperGAll_benjamini_correction)
list_of_ADseries_SOMclusterwise_hyperGOresult_BP_tables_topten_AS_plausible <- purrr::map(.x = list_of_ADseries_SOMclusterwise_hyperGOresult_BP_tables_AS_plausible, ~.[order(.$Padj, decreasing = FALSE), ] %>% head(n = 10))
list_of_ADseries_SOMclusterwise_hyperGOresult_BP_tables_topten_AS_plausible <- purrr::map2(.x = list_of_ADseries_SOMclusterwise_hyperGOresult_BP_tables_topten_AS_plausible, .y = 1:(AD_xdim * AD_ydim), .f = ~cbind(.x, cluster = .y))
# bind rows
wide_table_of_topten_hyperGOresult_BP_ADseries_AS_plausible <- purrr::reduce(.x = list_of_ADseries_SOMclusterwise_hyperGOresult_BP_tables_topten_AS_plausible, .f = bind_rows)
wide_table_of_topten_hyperGOresult_BP_ADseries_AS_plausible <- type_convert(wide_table_of_topten_hyperGOresult_BP_ADseries_AS_plausible)

list_of_ADseries_SOMclusterwise_hyperGOresult_CC_tables_AS_plausible <- purrr::map(.x = list_of_ADseries_gene_tables_by_SOM_cluster_flattened_AS_plausible, .f = ~GOHyperGAll(catdb = catdb, gocat = "CC", Nannot = 2, sample = .x) %>% GOHyperGAll_benjamini_correction)
list_of_ADseries_SOMclusterwise_hyperGOresult_CC_tables_topten_AS_plausible <- purrr::map(.x = list_of_ADseries_SOMclusterwise_hyperGOresult_CC_tables_AS_plausible, ~.[order(.$Padj, decreasing = FALSE), ] %>% head(n = 10))
list_of_ADseries_SOMclusterwise_hyperGOresult_CC_tables_topten_AS_plausible <- purrr::map2(.x = list_of_ADseries_SOMclusterwise_hyperGOresult_CC_tables_topten_AS_plausible, .y = 1:(AD_xdim * AD_ydim), .f = ~cbind(.x, cluster = .y))
# bind rows
wide_table_of_topten_hyperGOresult_CC_ADseries_AS_plausible <- purrr::reduce(.x = list_of_ADseries_SOMclusterwise_hyperGOresult_CC_tables_topten_AS_plausible, .f = bind_rows)
wide_table_of_topten_hyperGOresult_CC_ADseries_AS_plausible <- type_convert(wide_table_of_topten_hyperGOresult_CC_ADseries_AS_plausible)


# calculating the facet coordinates for 5x5 plot in ggplot ##########

list_of_wide_topten_clusterwise_tables_all_AS_plausible <- list(wide_table_of_topten_hyperGOresult_MF_ADseries_AS_plausible, wide_table_of_topten_hyperGOresult_BP_ADseries_AS_plausible, wide_table_of_topten_hyperGOresult_CC_ADseries_AS_plausible)
...
unprocessed_clusterwise_tables_topten_GOTERM_AS_plausible <- c("wide_table_of_topten_hyperGOresult_MF_ADseries_AS_plausible", "wide_table_of_topten_hyperGOresult_BP_ADseries_AS_plausible", "wide_table_of_topten_hyperGOresult_CC_ADseries_AS_plausible")
...
ggplot(wide_table_of_topten_hyperGOresult_MF_ADseries_AS_plausible_processed, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
  geom_col(aes(fill = log10(Padj))) +
  scale_fill_distiller(name = expression(log["10"](P["b-hoch"])), type = "seq", palette = "Purples", direction = -1,   aesthetics = "fill", na.value = "yellow") +
  facet_wrap(~cluster, scales = "free") +
  ggtitle("Top 10 significantly over-represented MF GO terms for each PLAUSIBLE cluster in AD series") +
  scale_x_discrete(labels = function(x) str_wrap(x, width = 35)) +
  xlab("GO term") +
  ylab("Number of genes in GO term") +
  # coord_cartesian(ylim = c(0, 20)) +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), strip.background = element_blank(), strip.text.x = element_blank(), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_figures, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries_AS_plausible), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_MF_GO_plausibleASlength.pdf", sep = ""), device = "pdf", dpi = 600, width = 45, height = 25, units = "cm") +
 ggsave(filename = paste(results_directory_figures, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries_AS_plausible), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_MF_GO_plausibleASlength.svg", sep = ""), device = "svg", dpi = 600, width = 45, height = 25, units = "cm")

write.table(x = wide_table_of_topten_hyperGOresult_MF_ADseries_AS_plausible_processed, file = paste(results_directory_figures, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries_AS_plausible), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_MF_GO_plausibleASlength.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)

# BP

ggplot(wide_table_of_topten_hyperGOresult_BP_ADseries_AS_plausible_processed, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
  geom_col(aes(fill = log10(Padj))) +
  scale_fill_distiller(name = expression(log["10"](P["b-hoch"])), type = "seq", palette = "Purples", direction = -1,   aesthetics = "fill", na.value = "yellow") +
  facet_wrap(~cluster, scales = "free") +
  ggtitle("Top 10 significantly over-represented BP GO terms for each PLAUSIBLE cluster in AD series") +
  scale_x_discrete(labels = function(x) str_wrap(x, width = 35)) +
  xlab("GO term") +
  ylab("Number of genes in GO term") +
  # coord_cartesian(ylim = c(0, 20)) +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), strip.background = element_blank(), strip.text.x = element_blank(), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_figures, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries_AS_plausible), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_BP_GO_plausibleASlength.pdf", sep = ""), device = "pdf", dpi = 600, width = 45, height = 25, units = "cm") +
 ggsave(filename = paste(results_directory_figures, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries_AS_plausible), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_BP_GO_plausibleASlength.svg", sep = ""), device = "svg", dpi = 600, width = 45, height = 25, units = "cm")

write.table(x = wide_table_of_topten_hyperGOresult_BP_ADseries_AS_plausible_processed, file = paste(results_directory_figures, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries_AS_plausible), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_BP_GO_plausibleASlength.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)

# CC

ggplot(wide_table_of_topten_hyperGOresult_CC_ADseries_AS_plausible_processed, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
  geom_col(aes(fill = log10(Padj))) +
  scale_fill_distiller(name = expression(log["10"](P["b-hoch"])), type = "seq", palette = "Purples", direction = -1,   aesthetics = "fill", na.value = "yellow") +
  facet_wrap(~cluster, scales = "free") +
  ggtitle("Top 10 significantly over-represented CC GO terms for each PLAUSIBLE cluster in AD series") +
  scale_x_discrete(labels = function(x) str_wrap(x, width = 35)) +
  xlab("GO term") +
  ylab("Number of genes in GO term") +
  # coord_cartesian(ylim = c(0, 20)) +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), strip.background = element_blank(), strip.text.x = element_blank(), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_figures, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries_AS_plausible), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_CC_GO_plausibleASlength.pdf", sep = ""), device = "pdf", dpi = 600, width = 45, height = 25, units = "cm") +
 ggsave(filename = paste(results_directory_figures, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries_AS_plausible), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_CC_GO_plausibleASlength.svg", sep = ""), device = "svg", dpi = 600, width = 45, height = 25, units = "cm")

write.table(x = wide_table_of_topten_hyperGOresult_CC_ADseries_AS_plausible_processed, file = paste(results_directory_figures, AD_xdim, "x", AD_ydim, "_SOM_", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries_AS_plausible), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_CC_GO_plausibleASlength.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
names(list_of_familyenrichment_by_SOM_cluster_ADseries_AS_plausible) <- 1:(AD_xdim * AD_ydim)

list_of_familyenrichment_by_SOM_cluster_ADseries_topten_AS_plausible <- purrr::map2(.x = list_of_familyenrichment_by_SOM_cluster_ADseries_AS_plausible, .y = 1:(AD_xdim * AD_ydim), .f = ~.x[order(.x$padj, decreasing = FALSE), ] %>% head(n = 10) %>% cbind(., cluster = .y) %>% as_tibble)
...
names(list_of_RBP_target_enrichment_by_SOM_cluster_ADseries_AS_plausible) <- 1:(AD_xdim * AD_ydim)

list_of_RBP_target_enrichment_by_SOM_cluster_ADseries_topten_AS_plausible <- purrr::map2(.x = list_of_RBP_target_enrichment_by_SOM_cluster_ADseries_AS_plausible, .y = 1:(AD_xdim * AD_ydim), .f = ~.x[order(.x$padj, decreasing = FALSE), ] %>% head(n = 10) %>% cbind(., cluster = .y) %>% as_tibble)
...
PSI_levels_timeseries_AD_wide_processed_AS_plausible_reordered <- PSI_levels_timeseries_AD_wide_processed_AS_plausible[ddr_order, ]

# rescaling

PSI_levels_timeseries_AD_wide_processed_AS_plausible_reordered[, ADseries_timepoints] <- PSI_levels_timeseries_AD_wide_processed_AS_plausible_reordered[, ADseries_timepoints] %>% genescale(m = ., axis = 1, method = "Z")
...
list_of_timeseries_PSI_tables_subsetted_by_consensus_cluster <- purrr::map2(.x = list_consensus_boundary_isoformIDs, .y = names(list_consensus_boundary_isoformIDs), .f = ~PSI_levels_timeseries_AD_wide_processed_AS_plausible_reordered[which(PSI_levels_timeseries_AD_wide_processed_AS_plausible_reordered$isoform_ID == .x[[1]]):which(PSI_levels_timeseries_AD_wide_processed_AS_plausible_reordered$isoform_ID == .x[[2]]), ] %>% cbind(., cluster = .y) %>% as_tibble)
...
ggplot(long_tibble_of_timeseries_PSI_tables_by_consensus_cluster, aes(x = timepoint, y = scaled_PSI_value)) +
  ...
  scale_colour_manual(values = c("black")) +
  facet_wrap(~cluster) +
  ggtitle(paste("Time series PSI profiles of", nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries_AS_plausible), "isoforms ADseries (any", p_or_q_value, qpvalue_cutoff, "dPSI greaterthan", dPSI_cutoff, "), 
...
list_of_ADseries_genes_by_consensus_cluster <- purrr::map(.x = list_of_timeseries_PSI_tables_subsetted_by_consensus_cluster, .f = ~.x$Gene %>% as.vector)

# let's try to do all enrichment at once using purrr

list_of_combinations_of_consensus_genes_and_GOterms <- cross2(.x = list_of_ADseries_genes_by_consensus_cluster, .y = list("MF", "BP", "CC"))

# note: each element will be [[1]]: gene set, [[2]]: GO term to query

list_of_ADseries_SOMclusterwise_hyperGOresult_allGO_tables_consensus <- purrr::map(.x = list_of_combinations_of_consensus_genes_and_GOterms, .f = ~GOHyperGAll(catdb = catdb, gocat = .x[[2]], Nannot = 2, sample = .x[[1]]) %>% GOHyperGAll_benjamini_correction)

list_of_ADseries_SOMclusterwise_hyperGOresult_allGO_tables_consensus_topten <- purrr::map(.x = list_of_ADseries_SOMclusterwise_hyperGOresult_allGO_tables_consensus, ~.[order(.$Padj, decreasing = FALSE), ] %>% head(n = 10))

list_of_ADseries_SOMclusterwise_hyperGOresult_allGO_tables_consensus_topten <- purrr::map2(.x = list_of_ADseries_SOMclusterwise_hyperGOresult_allGO_tables_consensus_topten, .y = 1:number_of_consensus_clusters %>% rep(., times = 3) %>% as.list, .f = ~cbind(.x, "cluster" = .y) %>% as_tibble)

list_of_ADseries_SOMclusterwise_hyperGOresult_allGO_tables_consensus_topten_2 <- list(
  "MF" = list_of_ADseries_SOMclusterwise_hyperGOresult_allGO_tables_consensus_topten[1:number_of_consensus_clusters] %>% purrr::reduce(bind_rows), 
  "BP" = list_of_ADseries_SOMclusterwise_hyperGOresult_allGO_tables_consensus_topten[(number_of_consensus_clusters + 1):(number_of_consensus_clusters*2)] %>% purrr::reduce(bind_rows),
  "CC" = list_of_ADseries_SOMclusterwise_hyperGOresult_allGO_tables_consensus_topten[((2*number_of_consensus_clusters) + 1):(number_of_consensus_clusters*3)] %>% purrr::reduce(bind_rows)) %>% purrr::map(~type_convert(.x))

# cheeky ggplot

purrr::map2(.x = list_of_ADseries_SOMclusterwise_hyperGOresult_allGO_tables_consensus_topten_2, .y = names(list_of_ADseries_SOMclusterwise_hyperGOresult_allGO_tables_consensus_topten_2), .f = ~ggplot(.x, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
  geom_col(aes(fill = log10(Padj))) +
  scale_fill_distiller(name = expression(log["10"](P)), type = "seq", palette = "Purples", direction = -1,   aesthetics = "fill", na.value = "yellow") +
  facet_wrap(~cluster, scales = "free") +
  ggtitle(paste("Top 10 significantly over-represented", .y, "GO terms for each PLAUSIBLE CONSENSUS cluster in AD series")) +
  scale_x_discrete(labels = function(x) str_wrap(x, width = 35)) +
  xlab("GO term") +
  ylab("Number of genes in GO term") +
  # coord_cartesian(ylim = c(0, 20)) +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), strip.background = element_blank(), strip.text.x = element_blank(), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_figures, "SOM_", number_of_consensus_clusters, "_consensus_clusters_",  nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries_AS_plausible), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_", .y, "_GO_plausibleASlength.pdf", sep = ""), device = "pdf", dpi = 600, width = 50, height = 30, units = "cm") +
 ggsave(filename = paste(results_directory_figures, "SOM_", number_of_consensus_clusters, "_consensus_clusters_",  nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries_AS_plausible), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_", .y, "_GO_plausibleASlength.svg", sep = ""), device = "svg", dpi = 600, width = 50, height = 30, units = "cm"))

purrr::map2(.x = list_of_ADseries_SOMclusterwise_hyperGOresult_allGO_tables_consensus_topten_2, .y = names(list_of_ADseries_SOMclusterwise_hyperGOresult_allGO_tables_consensus_topten_2), .f = ~write.table(x = .x, file = paste(results_directory_figures, "SOM_", number_of_consensus_clusters, "_consensus_clusters_",  nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries_AS_plausible), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_", .y, "_GO_plausibleASlength.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE))
...
list_of_ADseries_SOMclusterwise_familyenrichment_tables_consensus <- purrr::map(.x = list_of_ADseries_genes_by_consensus_cluster, .f = ~enrichment(genes = .x, reference = reference_geneset, genesets = list_of_pfam_gene_family_categories, adj = "BH", verbose = FALSE) %>% bc3net_benjamini_correction %>% cbind(., genes_contained = filtering_genehits_from_background_catalogue(list_of_pfam_gene_family_categories[.$TermID %>% as.character], .x) %>% lapply(toString) %>% paste(sep = ", ") %>% unlist) %>% type_convert %>% as_tibble)

names(list_of_ADseries_SOMclusterwise_familyenrichment_tables_consensus) <- 1:number_of_consensus_clusters

list_of_ADseries_SOMclusterwise_familyenrichment_tables_consensus_topten <- purrr::map2(.x = list_of_ADseries_SOMclusterwise_familyenrichment_tables_consensus, .y = 1:number_of_consensus_clusters, .f = ~.x[order(.x$padj, decreasing = FALSE), ] %>% head(n = 10) %>% cbind(., cluster = .y) %>% as_tibble)

# bind rows and calculate ggplot facet x and y coordinates
wide_table_of_ADseries_SOMclusterwise_familyenrichment_tables_consensus_topten <- purrr::reduce(.x = list_of_ADseries_SOMclusterwise_familyenrichment_tables_consensus_topten, .f = bind_rows) %>% type_convert

# ggplot

ggplot(wide_table_of_ADseries_SOMclusterwise_familyenrichment_tables_consensus_topten, aes(x = reorder(TermID, padj), y = genes)) +
  geom_col(aes(fill = log10(padj))) +
  scale_fill_distiller(name = expression(log["10"](P["b-hoch"])), type = "seq", palette = "Purples", direction = -1,   aesthetics = "fill", na.value = "yellow") +
  facet_wrap(~cluster, scales = "free") +
  ggtitle(paste("Top 10 significantly over-represented PFAM families for each PLAUSIBLE CONSENSUS cluster in AD series")) +
  scale_x_discrete(labels = function(x) str_wrap(x, width = 35)) +
  xlab("GO term") +
  ylab("Number of genes in GO term") +
  # coord_cartesian(ylim = c(0, 20)) +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), strip.background = element_blank(), strip.text.x = element_blank(), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_figures, "SOM_", number_of_consensus_clusters, "_consensus_clusters_",  nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries_AS_plausible), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_PFAMfamilies_plausibleASlength.pdf", sep = ""), device = "pdf", dpi = 600, width = 50, height = 30, units = "cm") +
 ggsave(filename = paste(results_directory_figures, "SOM_", number_of_consensus_clusters, "_consensus_clusters_",  nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries_AS_plausible), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_PFAMfamilies_GO_plausibleASlength.svg", sep = ""), device = "svg", dpi = 600, width = 50, height = 30, units = "cm")

write.table(x = wide_table_of_ADseries_SOMclusterwise_familyenrichment_tables_consensus_topten, file = paste(results_directory_figures, "SOM_", number_of_consensus_clusters, "_consensus_clusters_",  nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries_AS_plausible), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_PFAMfamilies_GO_plausibleASlength.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
list_of_ADseries_SOMclusterwise_RBPenrichment_tables_consensus <- purrr::map(.x = list_of_ADseries_genes_by_consensus_cluster, .f = ~enrichment(genes = .x, reference = reference_geneset, genesets = list_of_RBP_target_gene_categories, adj = "BH", verbose = FALSE) %>% bc3net_benjamini_correction %>% cbind(., genes_contained = filtering_genehits_from_background_catalogue(list_of_RBP_target_gene_categories[.$TermID %>% as.character], .x) %>% lapply(toString) %>% paste(sep = ", ") %>% unlist) %>% type_convert %>% as_tibble)

names(list_of_ADseries_SOMclusterwise_RBPenrichment_tables_consensus) <- 1:number_of_consensus_clusters

list_of_ADseries_SOMclusterwise_RBPenrichment_tables_consensus_topten <- purrr::map2(.x = list_of_ADseries_SOMclusterwise_RBPenrichment_tables_consensus, .y = 1:number_of_consensus_clusters, .f = ~.x[order(.x$padj, decreasing = FALSE), ] %>% head(n = 10) %>% cbind(., cluster = .y) %>% as_tibble)

# bind rows and calculate ggplot facet x and y coordinates
wide_table_of_ADseries_SOMclusterwise_RBPenrichment_tables_consensus_topten <- purrr::reduce(.x = list_of_ADseries_SOMclusterwise_RBPenrichment_tables_consensus_topten, .f = bind_rows) %>% type_convert

# ggplot

ggplot(wide_table_of_ADseries_SOMclusterwise_RBPenrichment_tables_consensus_topten, aes(x = reorder(TermID, padj), y = genes)) +
  geom_col(aes(fill = log10(pval))) +
  scale_fill_distiller(name = expression(log["10"](P["b-hoch"])), type = "seq", palette = "Purples", direction = -1,   aesthetics = "fill", na.value = "yellow") +
  facet_wrap(~cluster, scales = "free") +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_figures, "SOM_", number_of_consensus_clusters, "_consensus_clusters_",  nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries_AS_plausible), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_upstreamRBP_plausibleASlength.pdf", sep = ""), device = "pdf", dpi = 600, width = 50, height = 30, units = "cm") +
 ggsave(filename = paste(results_directory_figures, "SOM_", number_of_consensus_clusters, "_consensus_clusters_",  nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries_AS_plausible), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_upstreamRBP_GO_plausibleASlength.svg", sep = ""), device = "svg", dpi = 600, width = 50, height = 30, units = "cm")

write.table(x = wide_table_of_ADseries_SOMclusterwise_RBPenrichment_tables_consensus_topten, file = paste(results_directory_figures, "SOM_", number_of_consensus_clusters, "_consensus_clusters_",  nrow(wide_table_of_final_SOM_summary_5_by_5_ADseries_AS_plausible), "_isoforms_PSI_AD_diff_any_", p_or_q_value, qpvalue_cutoff, "_any_deltaPSI_greaterthan_", dPSI_cutoff, "_upstreamRBP_GO_plausibleASlength.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
logCPM_ADseries_anysig_DEGs_dir <- "Z:/PGNEXUS_kassem_MSC/Kassem_AD_fastqc/analysis_RSEM_local/run_1_original/R_processing_results/edgeR_anysig_DEGs_logCPM.txt"
...
logCPM_ADseries_snRNA <- dplyr::semi_join(logCPM_ADseries_anysig_DEGs, column_snRNA_genes_ADseries, by = "ensembl_gene_id") %>%
  ...
  # all pseudogenes
column_pseudogenes_genes_ADseries <- getBM(filters = c("biotype", "ensembl_gene_id"), values = list(c("transcribed_processed_pseudogene", "transcribed_unitary_pseudogene", "transcribed_unprocessed_pseudogene", "translated_processed_pseudogene"), logCPM_ADseries_anysig_DEGs$ensembl_gene_id), attributes = "ensembl_gene_id", mart = ensembl_mart) %>% as_tibble

logCPM_ADseries_pseudogene <- dplyr::semi_join(logCPM_ADseries_anysig_DEGs, column_pseudogenes_genes_ADseries, by = "ensembl_gene_id") %>%
...
logCPM_ADseries_subset <- dplyr::bind_rows(logCPM_ADseries_RBP, logCPM_ADseries_lncRNA, logCPM_ADseries_snRNA, logCPM_ADseries_pseudogene)
...
write.table(tibble_combinedexpr_logCPM_PSI_scaled, paste(results_directory_figures, "tibble_combinedexpr_logCPM_PSI_scaled_GRCh38.99.txt", sep = ""), sep = "\t", row.names = TRUE, quote = FALSE, col.names = TRUE)

tibble_combinedexpr_logCPM_PSI_scaled <- read.delim(paste(results_directory_figures, "tibble_combinedexpr_logCPM_PSI_scaled_GRCh38.99.txt", sep = ""), sep = "\t", row.names = NULL, stringsAsFactors = FALSE) %>% as_tibble %>% .[, -1] %>% setNames(c("Gene", "AS_event_ID", "splicemode", "isoform_ID", "MSC", "6h", "12h", "1d", "3d", "6d", "9d", "12d", "15d"))
...
tibble_consensus_matrix_combinedexpr_long <- read_delim(paste(results_directory_figures, "heatmap_som_consensus_matrix_combinedexpr_1520_isoforms_ADseries_any_qvalue0.01_dPSI_greaterthan_0.2_sweep_from_3x4_to_7x11_plausibleASlength.txt", sep = ""), delim = "\t")
...
list_genes_or_isoforms_from_combinedexpr_cooccuring <- purrr::map(.x = list_genes_or_isoforms_from_combinedexpr, .f = ~tibble_consensus_matrix_combinedexpr_long[tibble_consensus_matrix_combinedexpr_long$variable == .x & tibble_consensus_matrix_combinedexpr_long$cocluster_percentage >= 0.3, "gene_isoform_ID"])
...
list_genes_or_isoforms_from_combinedexpr_itemwise_intersection <- purrr::map2(.x = comparisons_genes_or_isoforms_from_combinedexpr %>% .[, 1] %>% array_tree %>% flatten, .y = comparisons_genes_or_isoforms_from_combinedexpr %>% .[, 2] %>% array_tree %>% flatten, .f = ~dplyr::intersect(list_genes_or_isoforms_from_combinedexpr_cooccuring[[.x]], list_genes_or_isoforms_from_combinedexpr_cooccuring[[.y]]) %>% nrow) %>% unlist %>% as.data.frame %>% as_tibble %>% setNames("coclustering_intersection")

list_genes_or_isoforms_from_combinedexpr_itemwise_setdiff <- purrr::map2(.x = comparisons_genes_or_isoforms_from_combinedexpr %>% .[, 1] %>% array_tree %>% flatten, .y = comparisons_genes_or_isoforms_from_combinedexpr %>% .[, 2] %>% array_tree %>% flatten, .f = ~dplyr::setdiff(list_genes_or_isoforms_from_combinedexpr_cooccuring[[.x]], list_genes_or_isoforms_from_combinedexpr_cooccuring[[.y]]) %>% nrow)  %>% unlist %>% as.data.frame %>% as_tibble %>% setNames("coclustering_setdiff")
...
write.table(x = list_genes_or_isoforms_from_combinedexpr_itemwise_intersection_2, file = paste(results_directory_figures, "list_genes_or_isoforms_from_combinedexpr_itemwise_intersection_2.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)

list_genes_or_isoforms_from_combinedexpr_itemwise_intersection_2 <- read_delim(paste(results_directory_figures, "list_genes_or_isoforms_from_combinedexpr_itemwise_intersection_2.txt", sep = ""), delim = "\t")


list_genes_or_isoforms_from_combinedexpr_itemwise_intersection_3 <- list_genes_or_isoforms_from_combinedexpr_itemwise_intersection_2[list_genes_or_isoforms_from_combinedexpr_itemwise_intersection_2$coclustering_intersection >= 100, ]

plot(density(list_genes_or_isoforms_from_combinedexpr_itemwise_intersection_3$jaccard %>% as.numeric))

# list_genes_or_isoforms_from_combinedexpr_itemwise_intersection <- purrr::map(.x = list_genes_or_isoforms_from_combinedexpr, .f = ~purrr::map2(.x = .x, .y = list_genes_or_isoforms_from_combinedexpr, .f = ~intersect(list_genes_or_isoforms_from_combinedexpr_cooccuring[[.x]], list_genes_or_isoforms_from_combinedexpr_cooccuring[[.y]])) %>% set_names(list_genes_or_isoforms_from_combinedexpr %>% unlist)) %>% set_names(list_genes_or_isoforms_from_combinedexpr %>% unlist)


write.table(x = list_genes_or_isoforms_from_combinedexpr_itemwise_intersection_3, file = paste(results_directory_figures, "list_genes_or_isoforms_from_combinedexpr_itemwise_intersection_3.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)




cytoscape_result <- read_delim(paste(results_directory_figures, "intersection100_penalty2_haircut0_multi_match_overlap0.8_seedeverynode.tab", sep = ""), delim = "\t", col_names = c("cluster", "gene_isoform_ID"))
...
list_combinedexpr_logCPM_PSI_scaled_clustered <- purrr::map(.x = list_cytoscape_cluster_results, .f = ~dplyr::left_join(tibble_combinedexpr_logCPM_PSI_scaled, .x, by = "isoform_ID"))

tibble_combinedexpr_logCPM_PSI_scaled <- bind_cols(tibble_combinedexpr_logCPM_PSI_scaled, gene_isoform_ID = paste(PSI_levels_timeseries_AD_wide_processed_AS_plausible$Gene, "_", PSI_levels_timeseries_AD_wide_processed_AS_plausible$isoform_ID, sep = ""))
...
PCA_result <- prcomp(tibble_combinedexpr_logCPM_PSI_scaled[, 5:ncol(tibble_combinedexpr_logCPM_PSI_scaled)] %>% t)
...
PCA_loadings <- PCA_result[["rotation"]] %>% as_tibble %>% add_column(isoform_ID = tibble_combinedexpr_logCPM_PSI_scaled$isoform_ID, .before = 1)

ggplot(PCA_loadings) + 
  geom_point(aes(y = PC2, x = PC1)) +
  ggtitle(paste("PCA plot of PSI combined with expr values", sep = "")) +
  xlab(paste("PC1 (", PCA_variance[1, "variance_explained"] %>% signif(3), "%)", sep = "")) +
  ylab(paste("PC2 (", PCA_variance[2, "variance_explained"] %>% signif(3), "%)", sep = "")) +
  theme_bw() +
  theme(text = element_text(family = "Helvetica")) 
...
matrix_consensus_matrix_combinedexpr_consensus_dendrogram_reordered
...
test <- e1071::cmeans(tibble_combinedexpr_logCPM_PSI_scaled[, 5:ncol(tibble_combinedexpr_logCPM_PSI_scaled)], 28, m = 1.1, dist = "euclidean", method = "cmeans", iter.max = 100, rate.par = 0.3)


View(test)

View(test$membership)

max(test$membership)

View(apply(test$membership, 1, max))

plot(density(apply(test$membership, 1, max)))

plot(density(apply(test$membership, 1, mean)))

plot(density(apply(test$membership, 1, sd)))


plot(density(test$membership[1, ]))


length(which(apply(test$membership, 1, FUN = function(X) {any(X %>% as.numeric > 0.3) == TRUE}) != TRUE))




tibble_combinedexpr_logCPM_PSI_scaled_testcmeans <- tibble_combinedexpr_logCPM_PSI_scaled %>% add_column("cluster" = test$cluster)

long_tibble_combinedexpr_logCPM_PSI_scaled_testcmeans <- reshape2::melt(tibble_combinedexpr_logCPM_PSI_scaled_testcmeans, id.vars = c("Gene", "AS_event_ID", "splicemode", "isoform_ID", "cluster"), variable.name = "timepoint", value.name = "scaled_PSI_value")




ggplot(long_tibble_combinedexpr_logCPM_PSI_scaled_testcmeans, aes(x = timepoint, y = scaled_PSI_value)) +
  geom_line(aes(group = isoform_ID)) +
  scale_colour_manual(values = c("black")) +
  facet_wrap(~cluster) +
  ggtitle(paste("cmeans, 60 partitions", sep = "")) +
  scale_x_discrete(limits = c("MSC", "6h", "12h", "1d", "3d", "6d", "9d", "12d", "15d"), labels = c("MSC", "6h", "12h", "1d", "3d", "6d", "9d", "12d", "15d")) +
  xlab("Time-point") +
...
list_consensus_combinedexpr_boundary_isoformIDs <- list("1" = list("MRPL23−AS1_RNASeq_lncRNA_ENSG00000226416", "UBE2Q2P1_A3SS_15_−_84527667_84532290_84538530_2"), 
                                           "2" = list("UBTF_cassette_exon_17_−_44212006_44212343_44212454_44212817_1", "C1orf122_A5SS_1_+_37808306_37808439_37808529_1"),
                                           "3" = list("AC000068.1_RNASeq_lncRNA_ENSG00000185065", "ENDOV_A3SS_17_+_80429831_80430033_80430039_80436131_1"),
                                           "4" = list("TMEM11_cassette_exon_17_−_21198840_21210935_21211227_21214089_1", "DRAM2_A3SS_1_−_111139666_111139711_111140036_2"), 
                                           "5" = list("ARHGEF10_cassette_exon_8_+_1876734_1880047_1880164_1882633_1", "TMEM87A_A5SS_15_−_42272123_42272887_42273253_2"),
                                           "6" = list("HAUS7_A5SS_X_−_153469261_153469743_153470448_1", "ASXL1_A5SS_20_+_32358832_32359334_32360806_32366382_1"), 
                                           "7" = list("AC092134.1_RNASeq_lncRNA_ENSG00000261707", "COL6A1_A5SS_21_+_46003857_46003998_46004574_2"), 
                                           "8" = list("WHAMMP3_RNASeq_pseudogene_ENSG00000276141", "DMPK_A3SS_19_−_45770640_45771396_45771566_1"),
                                           "9" = list("LAS1L_RNASeq_RBP_ENSG00000001497", "PGBD2_A3SS_1_+_248913879_248916600_248917277_1"),
                                           "10" = list("AFTPH_A3SS_2_+_64585545_64591883_64591886_1", "CNDP2_A3SS_18_+_74496431_74499880_74499935_2"),
                                           "11" = list("AC079329.1_RNASeq_lncRNA_ENSG00000254680", "PPRC1_A3SS_10_+_102144307_102145018_102148370_1"),
                                           "12" = list("MTSS2_composite_events_16_−_70678409_70679108_70679248_70679313_70679323_70679628_1", "EMC9_A3SS_14_−_24139614_24139789_24140887_1"),
                                           "13" = list("COA6_A5SS_1_+_234373678_234373840_234374228_1", "THOC2_A3SS_X_−_123601338_123603748_123610916_2"),
                                           "14" = list("ECT2_A5SS_3_+_172750857_172751116_172752472_172754507_1", "TACC1_composite_events_8_+_38728671_38757409_38787743_38788702_38820635_38825306_3"),
                                           "15" = list("PDZK1P1_RNASeq_pseudogene_ENSG00000215859", "TRIQK_A3SS_8_−_92886667_92886735_92891987_1"),
                                           "16" = list("ERH_RNASeq_RBP_ENSG00000100632", "RALGDS_A5SS_9_−_133112152_133120970_133148961_1"),
                                           "17" = list("STAG3L5P−PVRIG2P−PILRB_composite_events_7_+_100353270_100353371_100353483_100354012_100355141_2", "HIRA_A5SS_22_−_19407274_19408272_19408481_1"),
                                           "18" = list("RRP7BP_RNASeq_pseudogene_ENSG00000182841", "UPF3A_RNASeq_RBP_ENSG00000169062"),
                                           "19" = list("UPF3A_RNASeq_RBP_ENSG00000169062", "SIPA1L1_A5SS_14_+_71320503_71320552_71321120_2"),
                                           "20" = list("AC243585.2_RNASeq_lncRNA_ENSG00000277688", "AL451123.1_RNASeq_lncRNA_ENSG00000285103"),
                                           "21" = list("AC002398.1_RNASeq_lncRNA_ENSG00000267049", "MICAL3_A5SS_22_−_17906886_18001391_18024279_1"),
                                           "22" = list("MTSS2_composite_events_16_−_70678409_70679108_70679248_70679313_70679323_70679628_5", "AP3D1_A3SS_19_−_2112931_2112967_2113334_1"),
                                           "23" = list("SEMA4C_composite_events_2_−_96867923_96867926_96868414_96869185_96869874_3", "AC004908.1_RNASeq_lncRNA_ENSG00000272240"),
                                           "24" = list("SEC1P_RNASeq_pseudogene_ENSG00000232871", "LINC00534_RNASeq_lncRNA_ENSG00000253394"),
                                           "25" = list("SCAND2P_A3SS_15_+_84637420_84638352_84638394_2", "FAM197Y8_RNASeq_pseudogene_ENSG00000225560"),
                                           "26" = list("GTF3C1_A5SS_16_−_27463592_27464318_27464393_2", "AC009126.1_RNASeq_lncRNA_ENSG00000247121"),
                                           "27" = list("DDIT4−AS1_RNASeq_lncRNA_ENSG00000269926", "MIR4435−2HG_composite_events_2_−_111197194_111208661_111208754_111208977_111233739_111248241_111344059_7"),
                                           "28*" = list("LAS1L_RNASeq_RBP_ENSG00000001497", "CNDP2_A3SS_18_+_74496431_74499880_74499935_2"),
                                           "29*" = list("SCAND2P_A3SS_15_+_84637420_84638352_84638394_2", "AC009126.1_RNASeq_lncRNA_ENSG00000247121"))
...
list_of_timeseries_logCPM_PSI_genes_by_consensus_cluster_all <- purrr::map(.x = list_of_timeseries_logCPM_PSI_subsetted_by_consensus_cluster
                                                          , .f = ~.x$Gene %>% as.vector %>% unique)

list_of_timeseries_logCPM_PSI_genes_by_consensus_cluster_diffsplicedonly <- purrr::map(.x = list_of_timeseries_logCPM_PSI_subsetted_by_consensus_cluster
...
purrr::map2(.x = list_of_ADseries_consensus_combinedexpr_hyperGOresult_allGO_clusterwise_tables_topten_2, .y = names(list_of_ADseries_consensus_combinedexpr_hyperGOresult_allGO_clusterwise_tables_topten_2), .f = ~ggplot(.x, aes(x = reorder(Term, -SampleMatch), y = SampleMatch)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), strip.background = element_blank(), strip.text.x = element_blank(), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_figures, "som_consensus_matrix_combinedexpr_", number_of_consensus_combinedexpr_clusters, "_clusters_",  nrow(PSI_levels_timeseries_AD_wide_processed_AS_plausible), "_isoforms_ADseries_any_", p_or_q_value, qpvalue_cutoff, "_dPSI_greaterthan_", dPSI_cutoff, "_sweep_from_", min(xdim_range_combinedexpr), "x", min(ydim_range_combinedexpr), "_to_", max(xdim_range_combinedexpr), "x", max(ydim_range_combinedexpr), "_", .y, "_GO_plausibleASlength.pdf", sep = ""), device = "pdf", dpi = 600, width = 50, height = 30, units = "cm") +
 ggsave(filename = paste(results_directory_figures, "som_consensus_matrix_combinedexpr_", number_of_consensus_combinedexpr_clusters, "_clusters_",  nrow(PSI_levels_timeseries_AD_wide_processed_AS_plausible), "_isoforms_ADseries_any_", p_or_q_value, qpvalue_cutoff, "_dPSI_greaterthan_", dPSI_cutoff, "_sweep_from_", min(xdim_range_combinedexpr), "x", min(ydim_range_combinedexpr), "_to_", max(xdim_range_combinedexpr), "x", max(ydim_range_combinedexpr), "_", .y, "_GO_plausibleASlength.svg", sep = ""), device = "svg", dpi = 600, width = 50, height = 30, units = "cm"))

purrr::map2(.x = list_of_ADseries_consensus_combinedexpr_hyperGOresult_allGO_clusterwise_tables_topten_2, .y = names(list_of_ADseries_consensus_combinedexpr_hyperGOresult_allGO_clusterwise_tables_topten_2), .f = ~write.table(x = .x, file = paste(results_directory_figures, "som_consensus_matrix_combinedexpr_", number_of_consensus_combinedexpr_clusters, "_clusters_",  nrow(PSI_levels_timeseries_AD_wide_processed_AS_plausible), "_isoforms_ADseries_any_", p_or_q_value, qpvalue_cutoff, "_dPSI_greaterthan_", dPSI_cutoff, "_sweep_from_", min(xdim_range_combinedexpr), "x", min(ydim_range_combinedexpr), "_to_", max(xdim_range_combinedexpr), "x", max(ydim_range_combinedexpr), "_", .y, "_GO_plausibleASlength.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE))
...
ggplot(wide_table_of_ADseries_consensus_combinedexpr_familyenrichment_clusterwise_tables_topten, aes(x = reorder(TermID, padj), y = genes)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), strip.background = element_blank(), strip.text.x = element_blank(), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_figures, "som_consensus_matrix_combinedexpr_", number_of_consensus_combinedexpr_clusters, "_clusters_",  nrow(PSI_levels_timeseries_AD_wide_processed_AS_plausible), "_isoforms_ADseries_any_", p_or_q_value, qpvalue_cutoff, "_dPSI_greaterthan_", dPSI_cutoff, "_sweep_from_", min(xdim_range_combinedexpr), "x", min(ydim_range_combinedexpr), "_to_", max(xdim_range_combinedexpr), "x", max(ydim_range_combinedexpr), "_families_plausibleASlength.pdf", sep = ""), device = "pdf", dpi = 600, width = 50, height = 30, units = "cm") +
 ggsave(filename = paste(results_directory_figures, "som_consensus_matrix_combinedexpr_", number_of_consensus_combinedexpr_clusters, "_clusters_",  nrow(PSI_levels_timeseries_AD_wide_processed_AS_plausible), "_isoforms_ADseries_any_", p_or_q_value, qpvalue_cutoff, "_dPSI_greaterthan_", dPSI_cutoff, "_sweep_from_", min(xdim_range_combinedexpr), "x", min(ydim_range_combinedexpr), "_to_", max(xdim_range_combinedexpr), "x", max(ydim_range_combinedexpr), "_families_plausibleASlength.svg", sep = ""), device = "svg", dpi = 600, width = 50, height = 30, units = "cm")

write.table(x = wide_table_of_ADseries_consensus_combinedexpr_familyenrichment_clusterwise_tables_topten, file = paste(results_directory_figures, "som_consensus_matrix_combinedexpr_", number_of_consensus_combinedexpr_clusters, "_clusters_",  nrow(PSI_levels_timeseries_AD_wide_processed_AS_plausible), "_isoforms_ADseries_any_", p_or_q_value, qpvalue_cutoff, "_dPSI_greaterthan_", dPSI_cutoff, "_sweep_from_", min(xdim_range_combinedexpr), "x", min(ydim_range_combinedexpr), "_to_", max(xdim_range_combinedexpr), "x", max(ydim_range_combinedexpr), "_families_plausibleASlength.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
ggplot(wide_table_of_ADseries_consensus_combinedexpr_RBPenrichment_clusterwise_tables_topten, aes(x = reorder(TermID, padj), y = genes)) +
  geom_col(aes(fill = log10(pval))) +
  scale_fill_distiller(name = expression(log["10"](P["b-hoch"])), type = "seq", palette = "Purples", direction = -1,   aesthetics = "fill", na.value = "yellow") +
  facet_wrap(~cluster, scales = "free") +
  ggtitle(paste("Top 10 significantly over-represented upstream RBPs for each PLAUSIBLE CONSENSUS cluster in AD series")) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5, lineheight = 0.75, colour = "black"), legend.title.align = 0.5, legend.background = element_rect(size=0.5, linetype="solid", colour ="black"), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family="Helvetica")) +
 ggsave(filename = paste(results_directory_figures, "som_consensus_matrix_combinedexpr_", number_of_consensus_combinedexpr_clusters, "_clusters_",  nrow(PSI_levels_timeseries_AD_wide_processed_AS_plausible), "_isoforms_ADseries_any_", p_or_q_value, qpvalue_cutoff, "_dPSI_greaterthan_", dPSI_cutoff, "_sweep_from_", min(xdim_range_combinedexpr), "x", min(ydim_range_combinedexpr), "_to_", max(xdim_range_combinedexpr), "x", max(ydim_range_combinedexpr), "_upstreamRBP_plausibleASlength.pdf", sep = ""), device = "pdf", dpi = 600, width = 50, height = 30, units = "cm") +
 ggsave(filename = paste(results_directory_figures, "som_consensus_matrix_combinedexpr_", number_of_consensus_combinedexpr_clusters, "_clusters_",  nrow(PSI_levels_timeseries_AD_wide_processed_AS_plausible), "_isoforms_ADseries_any_", p_or_q_value, qpvalue_cutoff, "_dPSI_greaterthan_", dPSI_cutoff, "_sweep_from_", min(xdim_range_combinedexpr), "x", min(ydim_range_combinedexpr), "_to_", max(xdim_range_combinedexpr), "x", max(ydim_range_combinedexpr), "_upstreamRBP_plausibleASlength.svg", sep = ""), device = "svg", dpi = 600, width = 50, height = 30, units = "cm")

write.table(x = wide_table_of_ADseries_consensus_combinedexpr_RBPenrichment_clusterwise_tables_topten, file = paste(results_directory_figures, "som_consensus_matrix_combinedexpr_", number_of_consensus_combinedexpr_clusters, "_clusters_",  nrow(PSI_levels_timeseries_AD_wide_processed_AS_plausible), "_isoforms_ADseries_any_", p_or_q_value, qpvalue_cutoff, "_dPSI_greaterthan_", dPSI_cutoff, "_sweep_from_", min(xdim_range_combinedexpr), "x", min(ydim_range_combinedexpr), "_to_", max(xdim_range_combinedexpr), "x", max(ydim_range_combinedexpr), "_upstreamRBP_plausibleASlength.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
