...
JUM_diff_dir <- "//VBOXSVR/4tb_ironwolf/PGNEXUS_ADseries/analysis_JUM/run_1_PGNEXUS_ADseries_pvalue1/results/JUM_diff/"
...
write.table(x = matrix_consensus_matrix_combinedexpr_reordered, file = paste(results_directory_figures, "heatmap_som_consensus_matrix_combinedexpr_", nrow(PSI_levels_timeseries_AD_wide_processed_AS_plausible), "_isoforms_ADseries_any_", p_or_q_value, qpvalue_cutoff, "_dPSI_greaterthan_", dPSI_cutoff, "_sweep_from_", min(xdim_range_combinedexpr), "x", min(ydim_range_combinedexpr), "_to_", max(xdim_range_combinedexpr), "x", max(ydim_range_combinedexpr), "_plausibleASlength_wide.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
write.table(x = tibble_consensus_matrix_combinedexpr_long, file = paste(results_directory_figures, "heatmap_som_consensus_matrix_combinedexpr_", nrow(PSI_levels_timeseries_AD_wide_processed_AS_plausible), "_isoforms_ADseries_any_", p_or_q_value, qpvalue_cutoff, "_dPSI_greaterthan_", dPSI_cutoff, "_sweep_from_", min(xdim_range_combinedexpr), "x", min(ydim_range_combinedexpr), "_to_", max(xdim_range_combinedexpr), "x", max(ydim_range_combinedexpr), "_plausibleASlength_long.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
write.table(x = list_genes_or_isoforms_from_combinedexpr_itemwise_intersection_2, file = paste(results_directory_figures, "list_genes_or_isoforms_from_combinedexpr_itemwise_intersection_consensus0.5.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
cytoscape_result <- read_delim(paste(results_directory_figures, "intersection1_min25_penalty2_haircut0.1_multi_match_overlap0.8_seedeverynode.tab", sep = ""), delim = "\t", col_names = c("cluster", "gene_isoform_ID"))
