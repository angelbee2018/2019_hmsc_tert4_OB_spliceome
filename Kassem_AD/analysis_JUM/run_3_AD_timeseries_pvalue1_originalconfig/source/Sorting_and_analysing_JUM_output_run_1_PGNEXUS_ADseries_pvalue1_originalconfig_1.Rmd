...
# # GOTERM
polyA_RNAseq_GO_background <- getBM(filters = "biotype", values = c("protein_coding", "long_noncoding", "transcribed_processed_TFcomplex", "transcribed_unitary_TFcomplex", "transcribed_unprocessed_TFcomplex", "translated_processed_TFcomplex"), attributes = c("external_gene_name", "go_id", "namespace_1003"), mart = ensembl_mart) %>% .[.$namespace_1003 != "",]
