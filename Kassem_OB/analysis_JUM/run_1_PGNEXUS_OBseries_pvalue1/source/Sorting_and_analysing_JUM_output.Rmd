...
tibble_cumulative_diff_changes <- tibble("timepoint" = vector_OBseries_timepoints_edited, 
                                         "cumulative_diff_changes" = 
                                           c(0, 
                                             intersect(which(PSI_levels_timeseries_OB_wide_with_na[, which(str_detect(colnames(PSI_levels_timeseries_OB_wide_with_na), "qvalue"))] %>% .[, -which(str_detect(colnames(.), "12d|9d|6d|3d|24h|12h"))] <= 0.01), 
                                                       which(PSI_levels_timeseries_OB_wide_with_na[, which(str_detect(colnames(PSI_levels_timeseries_OB_wide_with_na), "deltaPSI"))] %>% .[, -which(str_detect(colnames(.), "12d|9d|6d|3d|24h|12h"))] >= 0.15)) %>% length,
                                             intersect(which(PSI_levels_timeseries_OB_wide_with_na[, which(str_detect(colnames(PSI_levels_timeseries_OB_wide_with_na), "qvalue"))] %>% .[, -which(str_detect(colnames(.), "12d|9d|6d|3d|24h"))] %>% apply(X = ., MARGIN = 1, FUN = function(X) {any(X %>% as.numeric %>% na.omit <= 0.01)} )), 
                                                       which(PSI_levels_timeseries_OB_wide_with_na[, which(str_detect(colnames(PSI_levels_timeseries_OB_wide_with_na), "deltaPSI"))] %>% .[, -which(str_detect(colnames(.), "12d|9d|6d|3d|24h"))] %>% apply(X = ., MARGIN = 1, FUN = function(X) {any(X %>% as.numeric %>% na.omit >= 0.15)} ))) %>% length,
                                             intersect(which(PSI_levels_timeseries_OB_wide_with_na[, which(str_detect(colnames(PSI_levels_timeseries_OB_wide_with_na), "qvalue"))] %>% .[, -which(str_detect(colnames(.), "12d|9d|6d|3d"))] %>% apply(X = ., MARGIN = 1, FUN = function(X) {any(X %>% as.numeric %>% na.omit <= 0.01)} )), 
                                                       which(PSI_levels_timeseries_OB_wide_with_na[, which(str_detect(colnames(PSI_levels_timeseries_OB_wide_with_na), "deltaPSI"))] %>% .[, -which(str_detect(colnames(.), "12d|9d|6d|3d"))] %>% apply(X = ., MARGIN = 1, FUN = function(X) {any(X %>% as.numeric %>% na.omit >= 0.15)} ))) %>% length,
                                             intersect(which(PSI_levels_timeseries_OB_wide_with_na[, which(str_detect(colnames(PSI_levels_timeseries_OB_wide_with_na), "qvalue"))] %>% .[, -which(str_detect(colnames(.), "12d|9d|6d"))] %>% apply(X = ., MARGIN = 1, FUN = function(X) {any(X %>% as.numeric %>% na.omit <= 0.01)} )), 
                                                       which(PSI_levels_timeseries_OB_wide_with_na[, which(str_detect(colnames(PSI_levels_timeseries_OB_wide_with_na), "deltaPSI"))] %>% .[, -which(str_detect(colnames(.), "12d|9d|6d"))] %>% apply(X = ., MARGIN = 1, FUN = function(X) {any(X %>% as.numeric %>% na.omit >= 0.15)} ))) %>% length,
                                             intersect(which(PSI_levels_timeseries_OB_wide_with_na[, which(str_detect(colnames(PSI_levels_timeseries_OB_wide_with_na), "qvalue"))] %>% .[, -which(str_detect(colnames(.), "12d|9d"))] %>% apply(X = ., MARGIN = 1, FUN = function(X) {any(X %>% as.numeric %>% na.omit <= 0.01)} )), 
                                                       which(PSI_levels_timeseries_OB_wide_with_na[, which(str_detect(colnames(PSI_levels_timeseries_OB_wide_with_na), "deltaPSI"))] %>% .[, -which(str_detect(colnames(.), "12d|9d"))] %>% apply(X = ., MARGIN = 1, FUN = function(X) {any(X %>% as.numeric %>% na.omit >= 0.15)} ))) %>% length,
                                             intersect(which(PSI_levels_timeseries_OB_wide_with_na[, which(str_detect(colnames(PSI_levels_timeseries_OB_wide_with_na), "qvalue"))] %>% .[, -which(str_detect(colnames(.), "12d"))] %>% apply(X = ., MARGIN = 1, FUN = function(X) {any(X %>% as.numeric %>% na.omit <= 0.01)} )), 
                                                       which(PSI_levels_timeseries_OB_wide_with_na[, which(str_detect(colnames(PSI_levels_timeseries_OB_wide_with_na), "deltaPSI"))] %>% .[, -which(str_detect(colnames(.), "12d"))] %>% apply(X = ., MARGIN = 1, FUN = function(X) {any(X %>% as.numeric %>% na.omit >= 0.15)} ))) %>% length,
                                             intersect(which(PSI_levels_timeseries_OB_wide_with_na[, which(str_detect(colnames(PSI_levels_timeseries_OB_wide_with_na), "qvalue"))] %>% apply(X = ., MARGIN = 1, FUN = function(X) {any(X %>% as.numeric %>% na.omit <= 0.01)} )), 
                                                       which(PSI_levels_timeseries_OB_wide_with_na[, which(str_detect(colnames(PSI_levels_timeseries_OB_wide_with_na), "deltaPSI"))] %>% apply(X = ., MARGIN = 1, FUN = function(X) {any(X %>% as.numeric %>% na.omit >= 0.15)} ))) %>% length)) %>% 
