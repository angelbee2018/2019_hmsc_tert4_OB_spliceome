...
message("total number of unique junction structures with any sort of transcript-level annotation: ", nrow(tibble_transcript_level_summary_count))
...
tibble_interpro_id_tally_per_ASeventID <- tibble::enframe(vector_unique_interpro_ids, name = NULL, value = "interpro_id") %>% dplyr::group_by(interpro_id) %>% dplyr::summarise("tally" = n())

message("total number of unique junction structures with any sort of protein-level annotation: ", nrow(tibble_protein_level_summary_count))

message("total number of unique junction structures overlapping an interpro domain: ", nrow(tibble_protein_level_summary_count))
