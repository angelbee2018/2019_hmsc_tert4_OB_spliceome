...
tibble_cumulative_diff_changes <- tibble("timepoint" = 1:OBseries_timepoints, 
...
ggplot(tibble_cumulative_diff_changes, aes(y = cumulative_diff_changes, x = timepoint)) +
  geom_point() +
  geom_smooth(formula = y ~ x, colour = "purple3", method = "loess", se = FALSE, span = 0.74999) +
  ggtitle("Cumulative changes in the hMSC-TERT4 spliceome\nOsteogenesis\nJUM") +
  xlab("Timepoint") +
  ylab("Cumulative differential changes") +
  scale_x_discrete(limits = c(1:8), labels = c("MSC", "6h", "12h", "1d", "3d", "6d", "9d", "12d")) +
  theme_bw() +
  theme(text = element_text(family = "Helvetica")) +
  ggsave(filename = paste(results_directory_figures, "plot_of_cumulative_changes_OBseries.pdf", sep = ""), device = "pdf", dpi = 600, width = 15, height = 15, units = "cm") +
  ggsave(filename = paste(results_directory_figures, "plot_of_cumulative_changes_OBseries.svg", sep = ""), device = "svg", dpi = 600, width = 15, height = 15, units = "cm")
