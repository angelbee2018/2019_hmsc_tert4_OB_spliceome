...
list_as.event.id_with_summarised_annotation_not.IR <- future_map(.x = as.event.id_array.tree_not.IR, .f = function(.x) {
  ...
  summarised_tibble_annotation <- tibble("AS_event_ID" = .x, 
                                         ...
                                         "NMD_reference" = subset_tibble_annotation$NMD_reference %>% unique %>% all == TRUE,
                                         "NMD_recon" = subset_tibble_annotation$NMD_recon %>% unique %>% all == TRUE,
...
list_as.event.id_with_summarised_annotation_IR <- future_imap(.x = as.event.id_array.tree_IR, .f = function(.x, .y) {
  ...
  summarised_tibble_annotation <- tibble("AS_event_ID" = .x, 
                                         ...
                                         "poison_exon_candidate_ref" = if (tibble_all_confirmed_IR_entries_ref == "uninit") {
                                           ...
                                           any(tibble_all_confirmed_IR_entries_ref$poison_exon_candidate_ref == TRUE)
                                         },
                                         "poison_exon_candidate_recon" = if (tibble_all_confirmed_IR_entries_recon == "uninit") {
                                           FALSE
                                         } else {
                                           any(tibble_all_confirmed_IR_entries_recon$poison_exon_candidate_recon == TRUE)
                                         },
                                         "contains_PTC_ref" = if (tibble_all_confirmed_IR_entries_ref == "uninit") {
                                           FALSE
                                         } else {
                                           any(tibble_all_confirmed_IR_entries_ref$contains_PTC_ref == TRUE)
                                         },
                                         "contains_PTC_recon" = if (tibble_all_confirmed_IR_entries_recon == "uninit") {
                                           FALSE
                                         } else {
                                           any(tibble_all_confirmed_IR_entries_recon$contains_PTC_recon == TRUE)
                                         },
                                         "first_or_last_exon_reference" = subset_tibble_annotation$first_or_last_exon_reference %>% paste(collapse = ";"),
                                         "first_or_last_exon_recon" = subset_tibble_annotation$first_or_last_exon_recon %>% paste(collapse = ";"),
                                         "any_first_exon" = any(c(grep(x = subset_tibble_annotation$first_or_last_exon_reference, pattern = "first_exon") %>% na.omit, 
...
tibble_junctions_per_category_all <- wide_tibble_all_splicemodes_split_with_na_with_ref_annot_2 %>% dplyr::distinct(., AS_event_ID, .keep_all = TRUE) %>% group_by(splicemode, first_exon_reference, last_exon_reference) %>% summarise(no_junctions_all = n())
...
tibble_junctions_per_category_constitutive <- PSI_levels_timeseries_constitutive_OB_wide_2 %>% dplyr::distinct(., AS_event_ID, .keep_all = TRUE) %>% group_by(splicemode, first_exon_reference, last_exon_reference) %>% summarise(no_junctions_constitutive = n())
...
tibble_junctions_per_category_differential <- PSI_levels_timeseries_OB_wide_with_na_2 %>% dplyr::distinct(., AS_event_ID, .keep_all = TRUE) %>% group_by(splicemode, first_exon_reference, last_exon_reference) %>% summarise(no_junctions_differential = n())
...
# melt the sample
long_tibble_junctions_per_category_summary <- reshape2::melt(tibble_junctions_per_category_summary, id.vars = c("splicemode", "first_exon_reference", "last_exon_reference"), variable.name = "sample", value.name = "number_of_junctions_per_category") %>% as_tibble %>% 
...
df <- wide_tibble_all_splicemodes_split_with_na_with_ref_annot_2 %>% dplyr::distinct(., AS_event_ID, .keep_all = TRUE) %>% .[, c("AS_event_ID", "splicemode", "any_NMD", "first_exon_reference", "last_exon_reference")] %>% add_column("dummy" = TRUE) %>% reshape2::dcast(formula = AS_event_ID + any_NMD + first_exon_reference + last_exon_reference ~ splicemode, value.var = "dummy") %>% as_tibble 
...
df <- PSI_levels_timeseries_OB_wide_with_na_2 %>% dplyr::distinct(., AS_event_ID, .keep_all = TRUE) %>% .[, c("AS_event_ID", "splicemode", "any_NMD", "first_exon_reference", "last_exon_reference")] %>% add_column("dummy" = TRUE) %>% reshape2::dcast(formula = AS_event_ID + any_NMD + first_exon_reference + last_exon_reference ~ splicemode, value.var = "dummy") %>% as_tibble 
...
## NMD
row.indices_NMD_ref <- grep(x = wide_tibble_all_splicemodes_split_with_na_with_ref_annot$NMD_reference, pattern = "TRUE")
