...
PSI_levels_timeseries_constitutive_OB_wide_with_na_na.rows <- apply(PSI_levels_timeseries_constitutive_OB_wide_with_na[, vector_OBseries_timepoints_edited], 1, function(X) {any(is.na(X))}) %>% which(. == TRUE)
