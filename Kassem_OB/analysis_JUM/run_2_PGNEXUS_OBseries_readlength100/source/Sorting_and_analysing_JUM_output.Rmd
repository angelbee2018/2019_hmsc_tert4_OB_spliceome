...
sampleandaccessionlists_dir <- "/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/"
# sampleandaccessionlists_dir <- "Z:/PGNEXUS_kassem_MSC/Kassem_OB/"

JUM_results_dir <- "/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/analysis_JUM/run_2_PGNEXUS_OBseries_readlength100/"
...
R_processing_results_dir <- "/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/analysis_JUM/run_2_PGNEXUS_OBseries_readlength100/R_processing_results/"
...
# tibble_ref_gtf <- rtracklayer::import("/media/Ubuntu/sharedfolder/hg38_ensembl_reference/gtf/Homo_sapiens.GRCh38.98_NMD_PTC_E4.gtf") %>% as_tibble
# tibble_recon_gtf <- rtracklayer::import("/media/Ubuntu/sharedfolder/hg38_ensembl_reference/gtf/alltimepoints_denovo_reconstructed_stringtiemerged_NMD_PTC_E4.gtf") %>% as_tibble
...
UNION_junc_coor_path <- "/media/sbi/4tb_ironwolf/PGNEXUS_OBseries/analysis_JUM/run_2_PGNEXUS_OBseries_readlength100/JUM_diff/UNION_junc_coor_with_junction_ID_more_than_5_read_in_at_least_3_samples.txt"
...
# export the constituent junctions for three-frame translation
# strsplit into a chr start end strand tibble
list_constituent_junctions <- PSI_levels_timeseries_constitutive_OB_wide_with_na[, c("Gene", "splicemode", "chr", "start", "end", "strand")] %>% 
  array_tree %>%
  # strsplit the chr, strand, start and end, and leave the rest alone.
  purrr::map(.f = function(a1) {
...
## write table
write.table(x = tibble_junction_table, file = paste(R_processing_results_dir, "wide_table_of_", PSI_levels_timeseries_constitutive_OB_wide_with_na$AS_event_ID %>% unique %>% length, "_constitutive_VSRs_", p_or_q_value, qpvalue_cutoff, "_dPSI", dPSI_cutoff, "_with_na_constituent_junctions.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
extract_diff_coord_from_entry_pairs <- function(list_of_junctions_of_transcripts_entry_pairs) {
  ...
  # DEBUG ###
  # list_of_junctions_of_transcripts_entry_pairs <- list_ref_entries_matched_to_constituent_junctions[[6]] %>% .$ref_matched_CDS_pairs
  ###########
...
list_genome_relative_differential_coords <- future_imap(.x = list_ref_entries_matched_to_constituent_junctions, .f = function(.x, .y) {
  ...
  # DEBUG ###
  # .x <- list_ref_entries_matched_to_constituent_junctions[[6]]
  ###########
