...
tibble_transcript_level_summary_count <- tibble_final_transcript_feature_annotation %>%
  dplyr::mutate("protein_coding" = grepl(x = tibble_overlapping_parent_transcript_features, pattern = "protein_coding"),
...
pdf(file = paste(R_processing_results_dir, "upset_plot_transcript_ontology_x_splicemode_", pvalue_or_FDR, pvalue_cutoff, "_dpsi", dpsi_cutoff, "_differential.pdf", sep = ""), height = 4, width = 20)
...
ht <- ComplexHeatmap::UpSet(upset_combs, 
                            ...
                            left_annotation = rowAnnotation("Set Type" = c(
                              ...
                              "MXS" = "Splicemode",
                              "SES" = "Splicemode")[set_name(upset_combs)], show_annotation_name = FALSE, 
                              col = list("Set Type" = c("Transcript type" = "tomato1", "Transcript region" = "sandybrown", "Splicemode" = "red4"))
                            ),
                            row_labels =  c("A3SS", "Protein coding", "miRNA", "Start codon", "Stop codon", "3' UTR", "5' UTR", "CDS", "A5SS", "IR", "MES", "MXS", "SES")
)
