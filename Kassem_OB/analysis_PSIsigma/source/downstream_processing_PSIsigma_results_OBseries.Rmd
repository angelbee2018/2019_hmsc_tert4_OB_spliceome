...
# reshaping into long table
list_of_long_tibbles_combinedexpr_logCPM_PSI_scaled_clustered <- purrr::map(.x = list_of_tibbles_combinedexpr_logCPM_PSI_scaled_clustered, .f = ~reshape2::melt(.x, variable.name = "timepoint", value.name = "scaled_PSI_value") %>% as_tibble)
