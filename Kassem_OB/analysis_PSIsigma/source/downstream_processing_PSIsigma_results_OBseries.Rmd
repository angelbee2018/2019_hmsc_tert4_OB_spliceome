...
annotate_differential_exon <- function(list_matched_ref_recon_gtf, original_tibble) {
  ...
  return(purrr::splice("diff_exon_coords" = list_matched_ref_recon_gtf$diff_exon_coords,
...
list_DEXSeq_results_tibble.only_with_PSI <- purrr::map2(.x = list_DEXSeq_results_tibble.only,
                                                        ...
                                                        .f = function(a1, a2) {
                                                          ...
                                                          tibble <- a1 %>% 
                                                            ...
                                                            dplyr::mutate("dpsi" = DEXSeq_PSI_first - DEXSeq_PSI_second)
...
# select only cols that are informative
  dplyr::select(id, DEXSeq_exonBaseMean, DEXSeq_dispersion, DEXSeq_stat, DEXSeq_pvalue, DEXSeq_padj, DEXSeq_log2FC_second_minus_first, comparison, DEXSeq_IR_first, DEXSeq_IR_second, DEXSeq_pseudotranscript_IR_plus_ER_first, DEXSeq_pseudotranscript_IR_plus_ER_second, DEXSeq_PSI_first, DEXSeq_PSI_second, dpsi)
...
tibble_differential_results_12d_vs_ud <- wide_tibble_of_psisigma_results_allcomparisons_differential %>% dplyr::filter(comparison == "BM_MSC_to_OB_12d_vs_BM_MSC_to_OB_ud" & !!as.name(pvalue_or_FDR) <= pvalue_cutoff & abs(dpsi) >= dpsi_cutoff)
# write table
