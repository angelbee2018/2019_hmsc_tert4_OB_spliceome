...
# for non-IR events, match exons.
list_ref_matching_exon_entries_not_IR <- future_imap(.x = wide_tibble_of_all_unique_exon_coords_array.tree_not_IR, .f = function(a1, a2) {
  
  # DEBUG ###
  # a1 <- wide_tibble_of_all_unique_exon_coords_array.tree_not_IR[[1]]
  # a2 <- 1
  ###########
  ...
  list(
  "reference_gtf_match" = extract_overlapping.exons(a1, tibble_ref_gtf), 
  "reconstructed_gtf_match" = extract_overlapping.exons(a1, tibble_recon_gtf), 
  "diff_exon_coords" = a1$diff_exon_coords,
  "diff_exon_chr" = a1$diff_exon_chr,
  "diff_exon_start" = a1$diff_exon_start,
  "diff_exon_end" = a1$diff_exon_end,
  "splicemode" = a1$splicemode) %>% return
...
list_ref_matching_exon_entries_all_array.tree_IR_reannotated <- future_imap(.x = list_ref_matching_exon_entries_all_array.tree_IR, .f = function(.x, .y) {
  ...
  # DEBUG ###
  # .x <- list_ref_matching_exon_entries_all_array.tree_IR[[1]]
  # tibble_ref_gtf <- tibble_ref_gtf
  # tibble_recon_gtf <- tibble_recon_gtf
  ###########
...
<<<<<<< HEAD
>>>>>>> 7bba5592d9cbb01b9c4e9db1c3a1d0f3b43d5e39
=======
>>>>>>> refs/remotes/origin/master
```