...
ggplot() +
  ...
  scale_colour_manual(values = c("black")) +
  facet_grid(inclusion_or_exclusion ~ paste("cluster =", scRNAseq_cluster)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1), legend.background = element_rect(size = 0.5, linetype = "solid", colour = "black"), text = element_text(family = "Helvetica")) +
 ggsave(filename = paste(OBseries_R_processing_results_dir, "gene_expression_profiles_biomarkers_per_scRNAseq_cluster_OBseries_qvalue0.01_fc2.pdf", sep = ""), device = "pdf", dpi = 600, width = 40, height = 11, units = "cm") +
 ggsave(filename = paste(OBseries_R_processing_results_dir, "gene_expression_profiles_biomarkers_per_scRNAseq_cluster_OBseries_qvalue0.01_fc2.svg", sep = ""), device = "svg", dpi = 600, width = 40, height = 11, units = "cm")
...
vector_goterms_to_plot <- c("response to unfolded protein", "mitotic cell cycle", "negative regulation of mitotic cell cycle", "ossification", "response to glucocorticoid", "osteoblast differentiation", "extracellular matrix organization", "actin cytoskeleton organization", "p38MAPK cascade", "Wnt signaling pathway", "regulation of BMP signaling pathway", "negative regulation of cell death", "integrin-mediated signaling pathway", "cell migration")
