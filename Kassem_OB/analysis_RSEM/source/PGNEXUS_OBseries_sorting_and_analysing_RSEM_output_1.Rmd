...
list_of_probability_cdf_bootstrap_tibbles <- purrr::map2(
  ...
  .f = function(a1, a2) {
    ...
    purrr::map2(
      ...
      .f = function(b1, b2) {
        ...
        }, .progress = TRUE, .options = future_options(globals = c("wide_tibble_of_final_SOM_summary_5_by_5_OBseries_edited", "sample_size", "dplyr::sample_n", "vec_timepoints_for_bootstrap", "dplyr::mutate_all")) ) %>% rbindlist %>% as_tibble
