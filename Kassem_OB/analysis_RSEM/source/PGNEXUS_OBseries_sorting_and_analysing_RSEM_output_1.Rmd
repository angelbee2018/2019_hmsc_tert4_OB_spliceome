...
tibble_inclusion_exclusion_biomarkers_expression_average.line <- tibble_inclusion_exclusion_biomarkers_expression %>% dplyr::group_by(inclusion_or_exclusion, scRNAseq_cluster, timepoint) %>% 
  dplyr::summarise("avg_expr" = mean(scaled_expr),
...
tibble_inclusion_exclusion_biomarkers_expression_average.line[, "scRNAseq_cluster"] <- factor(tibble_inclusion_exclusion_biomarkers_expression_average.line$scRNAseq_cluster %>% as.character, levels = c(11, 1, 3, 6, 10, 7, 8, 0, 2, 9, 5, 4) %>% as.character)
...
ggplot() +
  ...
  geom_line(data = tibble_inclusion_exclusion_biomarkers_expression_average.line, aes(x = timepoint, y = avg_expr, group = scRNAseq_cluster), colour = "white", size = 0.7) +
  scale_colour_manual(values = c("black")) +
...
ggplot() +
  geom_col(data = tibble_inclusion_exclusion_biomarkers_expression_average.line, aes(x = timepoint, y = avg_expr, group = scRNAseq_cluster, fill = inclusion_or_exclusion), colour = "black", size = 0.2) +
  geom_errorbar(data = tibble_inclusion_exclusion_biomarkers_expression_average.line, aes(x = timepoint, ymax = avg_expr_plus_1sd, ymin = avg_expr_minus_1sd, group = scRNAseq_cluster), colour = "black", size = 0.2) +
  scale_colour_manual(values = c("black")) +
