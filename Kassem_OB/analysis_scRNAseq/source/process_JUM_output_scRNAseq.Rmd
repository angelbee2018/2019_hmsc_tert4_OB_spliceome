...
R_processing_results_dir <- "Z:/PGNEXUS_kassem_MSC/Kassem_OB/analysis_scRNAseq/R_processing_results/JUM/"
...
JUM_results_dir <- "Z:/PGNEXUS_kassem_MSC/Kassem_OB/analysis_scRNAseq/results_JUM/run_2_clusters_and_anticlusters/"
...
long_tibble_LSV_biomarkers_per_cluster_filtered_by_bulk <- dplyr::inner_join(long_tibble_LSV_biomarkers_per_cluster, tibble_JUM_differential_dpsi0.15_qvalue0.01_with_na %>% dplyr::select(Gene, AS_event_ID, sub_junction_start_coor, sub_junction_end_coor) %>% setNames(c("Gene", "AS_event_ID_bulk", "sub_junction_start_coor_bulk", "sub_junction_end_coor_bulk")), by = c("Gene"))
# write table
