...
list_JUM_PSIsigma_combined_diff_coordinate_level_clip_seq_geneset_targets_and_GOterms <- future_pmap(
  .l = list(
    "a1" = list_JUM_PSIsigma_combined_diff_VSR_overlapping_clip_seq_matched_to_combinedexpr_table[!grepl(x = list_JUM_PSIsigma_combined_diff_VSR_overlapping_clip_seq_matched_to_combinedexpr_table %>% names, pattern = "(SRSF2 HITS-CLIP GSE111900)|SRSF1 |(SRSF4)|(SRSF7)|(SRSF9)|RBM15")], 
    "a2" = list(
      # "JUM_and_PSIsigma_differential|SRSF1 FLASH GSE118265" = c(2, 3),
      "JUM_and_PSIsigma_differential|SRSF2 FLASH GSE118265" = c(1, 2, 4, 7),
      "JUM_and_PSIsigma_differential|SRSF3 FLASH GSE118265" = c(2),
      "JUM_and_PSIsigma_differential|SRSF5 FLASH GSE118265" = c(1),
      "JUM_and_PSIsigma_differential|SRSF6 FLASH GSE118265" = c(1, 2, 4, 7),
      "JUM_and_PSIsigma_differential|SRSF11 FLASH GSE118265" = c(1, 5, 8, 10, 12),
      "JUM_and_PSIsigma_differential|HNRNPA1 eCLIP ENCODE" = c(4),
      "JUM_and_PSIsigma_differential|HNRNPA2B1 HITS-CLIP GSM1716538" = c(1, 2, 4, 5),
      "JUM_and_PSIsigma_differential|MBNL1 HITS-CLIP GSE76486" = c(1, 2, 3, 6, 7, 13, 14),
      "JUM_and_PSIsigma_differential|PRPF4 eCLIP ENCODE" = c(6),
      # "JUM_and_PSIsigma_differential|RBM15 eCLIP ENCODE" = c(6),
      "JUM_and_PSIsigma_differential|SFPQ eCLIP ENCODE" = c(1, 4, 7),
      "JUM_and_PSIsigma_differential|SUGP2 eCLIP ENCODE" = c(3, 4, 5, 6, 14),
      "JUM_and_PSIsigma_differential|TRA2A eCLIP ENCODE" = c(1, 3, 4, 9),
      "JUM_and_PSIsigma_differential|SNRPA eCLIP GSM4512295" = c(4)
    ), 
    "a3" = names(list_JUM_PSIsigma_combined_diff_VSR_overlapping_clip_seq_matched_to_combinedexpr_table[!grepl(x = list_JUM_PSIsigma_combined_diff_VSR_overlapping_clip_seq_matched_to_combinedexpr_table %>% names, pattern = "(SRSF2 HITS-CLIP GSE111900)|SRSF1 |(SRSF4)|(SRSF7)|(SRSF9)|RBM15")])
  ),
  .f = function(a1, a2, a3) {
  ...
  set_names(names(list_JUM_PSIsigma_combined_diff_VSR_overlapping_clip_seq_matched_to_combinedexpr_table[!grepl(x = list_JUM_PSIsigma_combined_diff_VSR_overlapping_clip_seq_matched_to_combinedexpr_table %>% names, pattern = "(SRSF2 HITS-CLIP GSE111900)|SRSF1 |(SRSF4)|(SRSF7)|(SRSF9)|RBM15")]))
...
list_clip_seq_entries_overlapping_VSRs_diff <- list_clip_seq_entries_overlapping_VSRs_diff[!grepl(x = list_clip_seq_entries_overlapping_VSRs_diff %>% names, pattern = "(SRSF2 HITS-CLIP GSE111900)|SRSF1 |(SRSF4)|(SRSF7)|(SRSF9)|RBM15")]
  ...
  .f = function(a1) {
    ...
    list_of_subset_tibbles <- future_map(
      ...
      .f = function(b1) {
        ...
        subset_tibble <- tibble_ebi_gwas_catalog %>% dplyr::filter(CHR_ID == b1$clipseq_chr &
                                                                     b1$clipseq_start %>% type.convert - 2 <= CHR_POS &
                                                                     CHR_POS <= b1$clipseq_end %>% type.convert + 2)
      ...
      }, .progress = TRUE, .options = future_options(globals = c("tibble_ebi_gwas_catalog", "add_column", "dplyr")) )
    
    # rbind and tibblise
    
    return(list_of_subset_tibbles %>% rbindlist %>% as_tibble)
    
  }, .progress = TRUE, .options = future_options(globals = c("tibble_ebi_gwas_catalog", "dplyr", "data.table", "tibble")))
