...
# JUM ###
tibble_JUM_scaled_PSI_timeseries_wide <- read.delim("Z:/PGNEXUS_kassem_MSC/Kassem_OB/analysis_JUM/run_2_PGNEXUS_OBseries_readlength100/R_processing_results/wide_table_of_908_differential_VSRs_qvalue0.01_dPSI0.15_timeseries_scaled.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE, check.names = FALSE) %>% as_tibble
...
tibble_JUM_constitutive_dpsi0.15_qvalue0.01_with_na <- read.delim("Z:/PGNEXUS_kassem_MSC/Kassem_OB/analysis_JUM/run_2_PGNEXUS_OBseries_readlength100/R_processing_results/wide_table_of_8294_constitutive_VSRs_dPSI_OB_diff_qvalue0.01_dPSI0.15_no_na.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE, check.names = FALSE) %>% as_tibble
# tibble_JUM_constitutive_dpsi0.15_qvalue0.01_with_na <- read.delim("/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/analysis_JUM/run_1_PGNEXUS_OBseries_pvalue1/results/figures/wide_table_of_8294_constitutive_VSRs_dPSI_OB_diff_qvalue0.01_dPSI0.15_no_na.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE) %>% as_tibble

tibble_JUM_all_junctions_with_na <- read.delim("Z:/PGNEXUS_kassem_MSC/Kassem_OB/analysis_JUM/run_2_PGNEXUS_OBseries_readlength100/R_processing_results/wide_table_of_all_JUM_results_13816_VSRs_with_na.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE, check.names = FALSE) %>% as_tibble
# tibble_JUM_all_junctions_with_na <- read.delim("/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/analysis_JUM/run_1_PGNEXUS_OBseries_pvalue1/results/figures/wide_table_of_all_JUM_results_13816_VSRs_with_na.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE) %>% as_tibble

# PSI-Sigma ###
tibble_PSIsigma_scaled_PSI_timeseries_wide <- read.delim("Z:/PGNEXUS_kassem_MSC/Kassem_OB/analysis_PSIsigma/results/run_1.9g_in_parallel_with_denominator/R_processing_results/wide_table_of_1032LIVs_scaled.PSI_OB_diff.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE, check.names = FALSE) %>% as_tibble
# tibble_PSIsigma_scaled_PSI_timeseries_wide <- read.delim("/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/analysis_PSIsigma/results/run_1.9g_in_parallel_with_denominator/R_processing_results/wide_table_of_1032LIVs_scaled.PSI_OB_diff.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE, check.names = FALSE) %>% as_tibble

tibble_PSIsigma_differential_dpsi0.10_pvalue0.01_with_na <- read.delim("Z:/PGNEXUS_kassem_MSC/Kassem_OB/analysis_PSIsigma/results/run_1.9g_in_parallel_with_denominator/R_processing_results/long_tibble_of_psisigma_results_allcomparisons_differential_info_LIV1704_dpsi15_DEXSeq_padj0.01_anysig_with_na.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE, check.names = FALSE) %>% as_tibble
# tibble_PSIsigma_differential_dpsi0.10_pvalue0.01_with_na <- read.delim("/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/analysis_PSIsigma/results/run_1.9g_in_parallel_with_denominator/R_processing_results/long_tibble_of_psisigma_results_allcomparisons_differential_info_LIV1704_dpsi15_DEXSeq_padj0.01_anysig_with_na.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE) %>% as_tibble

tibble_PSIsigma_constitutive_dpsi0.10_pvalue0.01_with_na <- read.delim("Z:/PGNEXUS_kassem_MSC/Kassem_OB/analysis_PSIsigma/results/run_1.9g_in_parallel_with_denominator/R_processing_results/wide_table_of_8294_constitutive_VSRs_dPSI_OB_diff_qvalue0.01_dPSI0.15_no_na.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE, check.names = FALSE) %>% as_tibble
# tibble_PSIsigma_constitutive_dpsi0.10_pvalue0.01_with_na <- read.delim("/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/analysis_PSIsigma/results/run_1.9g_in_parallel_with_denominator/R_processing_results/wide_table_of_8294_constitutive_VSRs_dPSI_OB_diff_qvalue0.01_dPSI0.15_no_na.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE) %>% as_tibble

tibble_PSIsigma_all_exons_with_na <- read.delim("Z:/PGNEXUS_kassem_MSC/Kassem_OB/analysis_PSIsigma/results/run_1.9g_in_parallel_with_denominator/R_processing_results/long_tibble_of_psisigma_DEXSeq_results.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE, check.names = FALSE) %>% as_tibble
# tibble_PSIsigma_all_exons_with_na <- read.delim("/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/analysis_PSIsigma/results/run_1.9g_in_parallel_with_denominator/R_processing_results/long_tibble_of_psisigma_DEXSeq_results.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE) %>% as_tibble
...
# JUM ###
tibble_JUM_junction_ontology_supp_info <- read.delim("/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/analysis_JUM/run_1_PGNEXUS_OBseries_pvalue1/results/table_junction_ontology_supporting_info_all_differential.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE, check.names = FALSE) %>% as_tibble
# PSI-Sigma ###
tibble_PSIsigma_exon_ontology_supp_info <- read.delim("/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/analysis_PSIsigma/results/run_2_psi.sigma.1.9_in_parallel/R_processing_results/table_exon_ontology_supporting_info_all_differential.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE, check.names = FALSE) %>% as_tibble
...
# JUM ###
tibble_JUM_junction_ontology_transcripts <- read.delim("/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/analysis_JUM/run_1_PGNEXUS_OBseries_pvalue1/results/table_junction_ontology_matched_transcript_features_all_differential.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE, check.names = FALSE) %>% as_tibble
tibble_JUM_junction_ontology_biomart <- read.delim("/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/analysis_JUM/run_1_PGNEXUS_OBseries_pvalue1/results/table_junction_ontology_matched_biomart_domains_all_differential.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE, check.names = FALSE) %>% as_tibble
tibble_JUM_junction_ontology_PTM <- read.delim("/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/analysis_JUM/run_1_PGNEXUS_OBseries_pvalue1/results/table_junction_ontology_matched_PTMs_all_differential.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE, check.names = FALSE) %>% as_tibble

# PSI-Sigma ###
tibble_PSIsigma_exon_ontology_transcripts <- read.delim("/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/analysis_PSIsigma/results/run_2_psi.sigma.1.9_in_parallel/R_processing_results/table_exon_ontology_matched_transcript_features_all_differential.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE, check.names = FALSE) %>% as_tibble
tibble_PSIsigma_exon_ontology_biomart <- read.delim("/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/analysis_PSIsigma/results/run_2_psi.sigma.1.9_in_parallel/R_processing_results/table_exon_ontology_matched_biomart_domains_all_differential.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE, check.names = FALSE) %>% as_tibble
tibble_PSIsigma_exon_ontology_PTM <- read.delim("/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/analysis_PSIsigma/results/run_2_psi.sigma.1.9_in_parallel/R_processing_results/table_exon_ontology_matched_PTMs_all_differential.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE, check.names = FALSE) %>% as_tibble
...
tibble_2020.PO4_2012.proteome_valid_junc.exons <- read.delim("/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/proteome_validation/results_maxquant/R_processing_results/table_brief.info_confirmed_junc.exons.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE, check.names = FALSE) %>% as_tibble
tibble_2020.PO4_valid_phosphosites <- read.delim("/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/proteome_validation/results_maxquant/R_processing_results/genome.relative.positions_2020_phosphoproteome_phosphosites.txt", sep = "\t", row.names = NULL, header = TRUE, stringsAsFactors = FALSE, check.names = FALSE) %>% as_tibble
...
tibble_fasta_supp_info_exons <- read.delim(file = "/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/proteome_validation/results_database_generation/angel_3FT_exons/exon_table_OB_diff_dpsi10_anypvalue0.01_3272_exons_anysig_with_na.txt", sep = "\t", row.names = NULL, header = TRUE) %>% as_tibble
...
tibble_fasta_supp_info_junctions <- read.delim(file = "/media/Ubuntu/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/proteome_validation/results_database_generation/angel_3FT_junctions/junction_table_OB_diff_any_qvalue0.01_any_deltaPSI_greaterthan_0.15.txt", sep = "\t", row.names = NULL, header = TRUE) %>% as_tibble
...
cat(magenta("JUM constitutive (", JUM_differential_dpsi0.15_qvalue0.01_with_na_vs_PSIsigma_differential_dpsi0.10_pvalue0.01_with_na$number_of_entries_tibble_1, ") vs. PSIsigma constitutive, (", JUM_differential_dpsi0.15_qvalue0.01_with_na_vs_PSIsigma_differential_dpsi0.10_pvalue0.01_with_na$number_of_entries_tibble_2, ") , the number of junctions/exons found in common are: ", JUM_differential_dpsi0.15_qvalue0.01_with_na_vs_PSIsigma_differential_dpsi0.10_pvalue0.01_with_na$number_of_common_entries, "\n"))
...
# write the consensus matrix table to file
write.table(x = tibble_consensus_matrix_reordered, file = paste(results_dir, "heatmap_som_consensus_matrix_combined_JUM_PSIsigma.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
save(tibble_consensus_matrix_reordered, file = paste(results_dir, "tibble_consensus_matrix_reordered.tibble", sep = ""))
load(file = paste(results_dir, "tibble_consensus_matrix_reordered.tibble", sep = ""))
...
save(tibble_consensus_matrix_long, file = paste(results_dir, "tibble_consensus_matrix_long.tibble", sep = ""))
load(file = paste(results_dir, "tibble_consensus_matrix_long.tibble", sep = ""))
...
# grep the corresponding cluster table from file
filename_of_clusterGO_result <- list.files(path = results_dir, pattern = paste("consensus_combinedexpr.*tab$", sep = ""))
...
# demultiplex the id column
wide_tibble_consensus_clusters_MQ_ratios <- dplyr::bind_cols(stringr::str_split_fixed(string = wide_tibble_consensus_clusters_MQ_ratios$id, pattern = "\\|", n = 6) %>% as_tibble %>% setNames(c("S1", "S2", "S3", "S4", "S5", "S6")),
...
ggplot() +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1), legend.background = element_rect(size = 0.5, linetype ="solid", colour = "black"), text = element_text(family = "Helvetica")) +
  ggsave(filename = paste(results_dir, "consensus_combinedexpr_timeseries_profiles.pdf", sep = ""), device = "pdf", dpi = 600, width = 35, height = 20, units = "cm") +
  ggsave(filename = paste(results_dir, "consensus_combinedexpr_timeseries_profiles.svg", sep = ""), device = "svg", dpi = 600, width = 35, height = 20, units = "cm")
...
ggplot(tibble_consensus.SOM_upstream.RBP.enrichment_clusterwise_top.hits %>% dplyr::arrange(pval), aes(x = reorder(TermID, pval), y = -log10(pval), size = (padj < 0.05) %>% as.character)) +
 ...
 ggsave(filename = paste(results_dir, "consensus.SOM_upstreamRBP_clusterwise_combinedexpr_top10.pdf", sep = ""), device = "pdf", dpi = 600, width = 40, height = 20, units = "cm") +
 ggsave(filename = paste(results_dir, "consensus.SOM_upstreamRBP_clusterwise_combinedexpr_top10.svg", sep = ""), device = "svg", dpi = 600, width = 40, height = 20, units = "cm")
...
tibble_PSIsigma_exon_ontology_supp_info_filtered_by_proteome <- dplyr::semi_join(tibble_PSIsigma_exon_ontology_supp_info %>%
                                                                                  add_column("Leading.razor.protein" = paste("exon_", .$diff_exon_coords, ":", .$matched_strand, sep = "")),
                                                                                tibble_2020.PO4_2012.proteome_valid_junc.exons, 
...
tibble_PSIsigma_exon_ontology_PTM_filtered <- dplyr::semi_join(tibble_PSIsigma_exon_ontology_PTM, tibble_PSIsigma_exon_ontology_supp_info_filtered_by_proteome, by = "diff_exon_coords")
...
ggplot(tibble_interpro_id_tally_per_diff_exon_coords %>% dplyr::arrange(desc(tally)) %>% head(90), aes(x = reorder(interpro_identifier, -tally), y = tally)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 8), axis.text.y = element_text(size = 20), axis.title.y = element_text(margin = margin(r = 90)), legend.title.align = 0.5, legend.background = element_rect(size = 0.5, linetype = "solid", colour = "black"), text = element_text(family = "Helvetica")) +
 ggsave(filename = paste(results_dir, "tally_overlapping_interpro_domains_PSISigma_anysig_with_na.pdf", sep = ""), device = "pdf", dpi = 600, width = 80, height = 10, units = "cm") +
 ggsave(filename = paste(results_dir, "tally_overlapping_interpro_domains_PSISigma_anysig_with_na.svg", sep = ""), device = "svg", dpi = 600, width = 80, height = 10, units = "cm") 

write.table(x = tibble_interpro_id_tally_per_diff_exon_coords %>% dplyr::arrange(desc(tally)), file = paste(results_dir, "tally_overlapping_interpro_domains_PSISigma_anysig_with_na.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE)
...
# PTM level
tibble_PTM_tally <- tibble_PSIsigma_exon_ontology_PTM_filtered %>% 
...
ggplot(tibble_PTM_tally, aes(x = reorder(PTM_type, -tally), y = tally)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title.y = element_text(margin = margin(r = 10)), legend.title.align = 0.5, legend.background = element_rect(size = 0.5, linetype = "solid", colour = "black"), text = element_text(family = "Helvetica")) +
 ggsave(filename = paste(results_dir, "tally_overlapping_PTMs_PSISigma_anysig_with_na.pdf", sep = ""), device = "pdf", dpi = 600, width = 4, height = 8, units = "cm") +
 ggsave(filename = paste(results_dir, "tally_overlapping_PTMs_PSISigma_anysig_with_na.svg", sep = ""), device = "svg", dpi = 600, width = 4, height = 8, units = "cm") 
...
list_logical_phosphosite_intersect_differential_CDS_positions <- purrr::map2(
  .x = tibble_2020.PO4_valid_phosphosites$identifier,
  .y = tibble_2020.PO4_valid_phosphosites$genome_relative_positions_phosphosite %>% strsplit(split = ","),
  .f = function(a1, a2) {
    
    subset_exon_ontology_supp_info_by_identifier <- tibble_PSIsigma_exon_ontology_supp_info_filtered_by_proteome[grep(x = tibble_PSIsigma_exon_ontology_supp_info_filtered_by_proteome$Leading.razor.protein, pattern = a1), ]
    
    intersecting_coords <- intersect(a2, 
                                     subset_exon_ontology_supp_info_by_identifier$vector_genomic_coords_of_all_differential_CDS_positions %>% strsplit(split = ",") %>% unlist)
...
### Meaning we need to cast onto the genome and convert to Granges:
...
### Preprocessing: convert differential positions into Granges
...
granges_JUM_differential_exonic_regions_all.RNA <- toGRanges(tibble_JUM_differential_genome.relative_chr.start.end[, c("chr", "start", "end")] %>% 
...
granges_PSIsigma_differential_exonic_regions_all.RNA <- toGRanges(tibble_PSIsigma_differential_genome.relative_chr.start.end[, c("chr", "start", "end")] %>% 
                                                       # turn chr column into chr1 chr2 etc...
                                                       dplyr::mutate_at(.vars = "chr", .funs = function(x) {paste("chr", x, sep = "")} ) %>%
                                                       type_convert %>% 
                                                       # data frame is absolutele necessary for regioneR.
...
granges_JUM_differential_exonic_regions_proteome.filtered.RNA <- toGRanges(tibble_JUM_differential_genome.relative_chr.start.end[, c("chr", "start", "end")] %>% 
                                                                             # turn chr column into chr1 chr2 etc...
                                                                             dplyr::mutate_at(.vars = "chr", .funs = function(x) {paste("chr", x, sep = "")} ) %>%
                                                                             type_convert %>% 
                                                                             # data frame is absolutele necessary for regioneR.
...
granges_PSIsigma_differential_exonic_regions_proteome.filtered.RNA <- toGRanges(tibble_PSIsigma_differential_genome.relative_chr.start.end[, c("chr", "start", "end")] %>% 
                                                       # turn chr column into chr1 chr2 etc...
                                                       dplyr::mutate_at(.vars = "chr", .funs = function(x) {paste("chr", x, sep = "")} ) %>%
                                                       type_convert %>% 
                                                       # data frame is absolutele necessary for regioneR.
...
granges_JUM_differential_CDS_regions_all.RNA <- toGRanges(tibble_JUM_differential_genome.relative_chr.start.end[, c("chr", "start", "end")] %>% 
                                                               # turn chr column into chr1 chr2 etc...
                                                               dplyr::mutate_at(.vars = "chr", .funs = function(x) {paste("chr", x, sep = "")} ) %>%
                                                               type_convert %>% 
                                                               # data frame is absolutele necessary for regioneR.
...
granges_JUM_differential_CDS_regions_proteome.filtered.RNA <- toGRanges(tibble_JUM_differential_genome.relative_chr.start.end[, c("chr", "start", "end")] %>% 
                                                                             # turn chr column into chr1 chr2 etc...
                                                                             dplyr::mutate_at(.vars = "chr", .funs = function(x) {paste("chr", x, sep = "")} ) %>%
                                                                             type_convert %>% 
                                                                             # data frame is absolutele necessary for regioneR.
...
# PSI-Sigma - unfiltered RNA
## create tibble of item coords and chr
tibble_PSIsigma_differential_CDS_coords_and_chr <- tibble_PSIsigma_exon_ontology_supp_info[, c("diff_exon_coords", "vector_genomic_coords_of_all_differential_CDS_positions")] %>%
  dplyr::mutate_at(.vars = "vector_genomic_coords_of_all_differential_CDS_positions", .funs = function(x) {strsplit(x, split = ",") %>% return} ) %>%
  dplyr::mutate_at(.vars = "diff_exon_coords", .funs = function(x) {gsub(x = x, pattern = "^([^\\:]+).*", replacement = "\\1") %>% return} ) %>% 
  dplyr::rename("chr" = "diff_exon_coords") %>%
  unnest(cols = "vector_genomic_coords_of_all_differential_CDS_positions") %>%
...
## convert vector of discontinuous sites into chr, start, end.
tibble_PSIsigma_differential_genome.relative_chr.start.end <- convert_vector.of.positions_to_simple.ranges(
  input_vector = tibble_PSIsigma_differential_CDS_coords_and_chr$vector_genomic_coords_of_all_differential_CDS_positions, 
...
granges_PSIsigma_differential_CDS_regions_all.RNA <- toGRanges(tibble_PSIsigma_differential_genome.relative_chr.start.end[, c("chr", "start", "end")] %>% 
                                                       # turn chr column into chr1 chr2 etc...
                                                       dplyr::mutate_at(.vars = "chr", .funs = function(x) {paste("chr", x, sep = "")} ) %>%
                                                       type_convert %>% 
                                                       # data frame is absolutele necessary for regioneR.
...
# PSI-Sigma - proteome-filtered RNA
## create tibble of item coords and chr
tibble_PSIsigma_differential_CDS_coords_and_chr <- tibble_PSIsigma_exon_ontology_supp_info_filtered_by_proteome[, c("diff_exon_coords", "vector_genomic_coords_of_all_differential_CDS_positions")] %>%
  dplyr::mutate_at(.vars = "vector_genomic_coords_of_all_differential_CDS_positions", .funs = function(x) {strsplit(x, split = ",") %>% return} ) %>%
  dplyr::mutate_at(.vars = "diff_exon_coords", .funs = function(x) {gsub(x = x, pattern = "^([^\\:]+).*", replacement = "\\1") %>% return} ) %>% 
  dplyr::rename("chr" = "diff_exon_coords") %>%
  unnest(cols = "vector_genomic_coords_of_all_differential_CDS_positions") %>%
...
granges_PSIsigma_differential_CDS_regions_proteome.filtered.RNA <- toGRanges(tibble_PSIsigma_differential_genome.relative_chr.start.end[, c("chr", "start", "end")] %>% 
                                                       # turn chr column into chr1 chr2 etc...
                                                       dplyr::mutate_at(.vars = "chr", .funs = function(x) {paste("chr", x, sep = "")} ) %>%
                                                       type_convert %>% 
...
#### create granges of transcript "type" and "biotype" (ensembl)

```{r}

list_granges_ensembl_transcript_types <- tibble_ref_gtf_original %>%
...
#### Cast biomart regions onto the genome
...
list_of_tibbles_biomart_regions_cast_onto_genome <- list_of_tibbles_biomart_domain_annotation %>% purrr::imap(.f = function(a1, a2) {
  
  # DEBUG ###
  # a1 <- list_of_tibbles_biomart_domain_annotation[["mobidblite"]]
  ###########
  ...
  a1 %>% 
    ...
    # the parent ENSP CDS positions are sorted already. we just retri eve the genome-relative positions using the CDS-relative positions. 
    # these are the regions casted onto the genome.
    dplyr::mutate("vec_all_genome_relative_coords_of_item" = future_map2(.x = `vec _all_CDS_relative_positions`, .y = `vec_all_parent_ENSP_CDS_positions_sorted`, .f = ~.y %>% unlist %>% .[.x], .progress = TRUE, .options = future_options(globals = FALSE))) %>%
    dplyr::mutate("nucleotide_width" = purrr::map(.x = `vec_all_genome_relative_coords_o>f_item`, .f = ~length(.x)) %>% unlist) %>% return
...
# save(tibble_ENSP_to_uniprotkb, file = paste(shared_dir, "tibble_ENSP_to_uniprotkb.tibble", paste = ""))
load(file = paste(shared_dir, "tibble_ENSP_to_uniprotkb.tibble", paste = ""))
...
# cast onto genome.save(tibble_dbPTM_allhuman_annotati
...
### Preprocessing: create a complement mask so we may only consider exonic or CDS positions.

```{r}

# convert the whole genome into a granges object
granges_UCSC_hg38 <- GRanges(seqinfo(BSgenome.Hsapiens.UCSC.hg38))

# convert the exome into a granges object
granges_ensembl_exome <- tibble_ref_gtf_original %>%
  dplyr::filter(type == "exon") %>%
  # turn chr column into chr1 chr2 etc...
  dplyr::select(chr, start, end) %>%
  dplyr::mutate_at(.vars = "chr", .funs = function(x) {paste("chr", x, sep = "")} ) %>%
  type_convert %>% 
  # data frame is absolutele necessary for granges
  as.data.frame %>%
  toGRanges 

# convert the CDSome into a granges object
granges_ensembl_codome <- tibble_ref_gtf_original %>%
  dplyr::filter(type == "CDS") %>%
  # turn chr column into chr1 chr2 etc...
  dplyr::select(chr, start, end) %>%
  dplyr::mutate_at(.vars = "chr", .funs = function(x) {paste("chr", x, sep = "")} ) %>%
...
granges_anti.exome_mask <- regioneR::subtractRegions(A = granges_UCSC_hg38,
                                                     B = granges_ensembl_exome)
# BSgenome.Hsapiens.UCSC.hg38_anti.exome.masked <- getGenomeAndMask(genome = BSgenome.Hsapiens.UCSC.hg38, mask = granges_anti.exome_mask)

granges_anti.CDS_mask <- regioneR::subtractRegions(A = granges_UCSC_hg38,
                                                     B = granges_ensembl_codome)
...
#### transcript regions - loop thru each type of region - **exonic** regions across GENOME.

```{r}

# permtest: JUM (all RNA)
permtest_JUM_diff.exonic.all.RNA_vs_fixed.genomic.ensembl.transcript.type <- purrr::map(.x = list_granges_ensembl_transcript_by_type_and_biotype[c("CDS", "five_prime_utr", "three_prime_utr", "protein_coding", "lncRNA", "miRNA")], 
                                                                                        .f = ~permTest(A = granges_JUM_differential_exonic_regions_all.RNA, 
                                                                                                       B = .x, 
...
save(permtest_JUM_diff.exonic.all.RNA_vs_fixed.genomic.ensembl.transcript.type, file = paste(results_dir, "permtest_JUM_diff.exonic.all.RNA_vs_fixed.genomic.ensembl.transcript.type.Rlist", sep = ""))
# load(file = paste(results_dir, "permtest_JUM_diff.exonic.all.RNA_vs_fixed.genomic.ensembl.transcript.type.Rlist", sep = ""))

# permtest: PSI-Sigma (all RNA)
permtest_PSIsigma_diff.exonic.all.RNA_vs_fixed.genomic.ensembl.transcript.type <- purrr::map(.x = list_granges_ensembl_transcript_by_type_and_biotype[c("CDS", "five_prime_utr", "three_prime_utr", "protein_coding", "lncRNA", "miRNA")], 
                                                                                             .f = ~permTest(A = granges_PSIsigma_differential_exonic_regions_all.RNA, 
                                                                                                            B = .x, 
                                                                                                            randomize.function = randomizeRegions,
                                                                                                            non.overlapping = TRUE,
                                                                                                            per.chromosome = FALSE, 
...
save(permtest_PSIsigma_diff.exonic.all.RNA_vs_fixed.genomic.ensembl.transcript.type, file = paste(results_dir, "permtest_PSIsigma_diff.exonic.all.RNA_vs_fixed.genomic.ensembl.transcript.type.Rlist", sep = ""))
# load(file = paste(results_dir, "permtest_PSIsigma_diff.exonic.all.RNA_vs_fixed.genomic.ensembl.transcript.type.Rlist", sep = ""))

```

#### biomarts regions - loop thru each type of region

```{r}

# grange-ify the dbPTM sites
## split by PTM type, unnest the item coords and chr
list_of_tibbles_biomart_coords_and_chr <- list_of_tibbles_biomart_regions_cast_onto_genome %>%
  future_map(~.x %>%
               dplyr::select(chr, vec_all_genome_relative_coords_of_item) %>% 
               unnest(cols = "vec_all_genome_relative_coords_of_item") %>% 
               dplyr::filter(is.na(vec_all_genome_relative_coords_of_item) != TRUE) %>%
               dplyr::arrange(vec_all_genome_relative_coords_of_item), .progress = TRUE, .options = future_options(globals = c("dplyr::select", "unnest", "dplyr::filter", "dplyr::arrange")))

# save(list_of_tibbles_biomart_coords_and_chr, file = paste(results_dir, "list_of_tibbles_biomart_coords_and_chr.Rlist", sep = ""))
# load(file = paste(results_dir, "list_of_tibbles_biomart_coords_and_chr.Rlist", sep = ""))

## convert vector of discontinuous sites into chr, start, end.
list_of_tibbles_biomart_regions_genome.relative_chr.start.end <- list_of_tibbles_biomart_coords_and_chr %>% purrr::map(~convert_vector.of.positions_to_simple.ranges(input_vector = .x$vec_all_genome_relative_coords_of_item, metadata_vector = .x$chr) %>% 
                                                                                                                         # rename metadata column)
                                                                                                                         dplyr::rename("chr" = "value") %>% 
                                                                                                                         # filter out non-1:22/X/Y chromosome entries
                                                                                                                         dplyr::filter(chr %in% c(1:22, "X", "Y")))

list_of_granges_biomart_regions_genome.relative <- list_of_tibbles_biomart_regions_genome.relative_chr.start.end %>% 
  purrr::map(~toGRanges(.x[, c("chr", "start", "end")] %>% 
                          # turn chr column into chr1 chr2 etc...
                          dplyr::mutate_at(.vars = "chr", .funs = function(x) {paste("chr", x, sep = "")} ) %>%
                          type_convert %>% 
...
save(list_of_granges_biomart_regions_genome.relative, file = paste(results_dir, "list_of_granges_biomart_regions_genome.relative.Rlist", sep = ""))
load(file = paste(results_dir, "list_of_granges_biomart_regions_genome.relative.Rlist", sep = ""))

# permtest: JUM (all RNA)
permtest_JUM_diff.CDS.all.RNA_vs_fixed.genomic.biomart <- purrr::map(.x = list_of_granges_biomart_regions_genome.relative, 
                                                                      .f = ~permTest(A = granges_JUM_differential_CDS_regions_all.RNA, 
                                                                                     B = .x, 
...
save(permtest_JUM_diff.CDS.all.RNA_vs_fixed.genomic.biomart, file = paste(results_dir, "permtest_JUM_diff.CDS.all.RNA_vs_fixed.genomic.biomart.Rlist", sep = ""))
# load(file = paste(results_dir, "permtest_JUM_diff.CDS.all.RNA_vs_fixed.genomic.biomart.Rlist", sep = ""))

# permtest: PSI-Sigma (all RNA)
permtest_PSIsigma_diff.CDS.all.RNA_vs_fixed.genomic.biomart <- purrr::map(.x = list_of_granges_biomart_regions_genome.relative, 
                                                                           .f = ~permTest(A = granges_PSIsigma_differential_CDS_regions_all.RNA, 
                                                                                          B = .x, 
                                                                                          randomize.function = circularRandomizeRegions,
                                                                                          evaluate.function = numOverlaps,
                                                                                          ntimes = 100000, 
...
save(permtest_PSIsigma_diff.CDS.all.RNA_vs_fixed.genomic.biomart, file = paste(results_dir, "permtest_PSIsigma_diff.CDS.all.RNA_vs_fixed.genomic.biomart.Rlist", sep = ""))
# load(file = paste(results_dir, "permtest_PSIsigma_diff.CDS.all.RNA_vs_fixed.genomic.biomart.Rlist", sep = ""))

# permtest: JUM (proteome-filtered RNA)
permtest_JUM_diff.CDS.proteome.filtered.RNA_vs_fixed.genomic.biomart <- purrr::map(.x = list_of_granges_biomart_regions_genome.relative, 
                                                                                    .f = ~permTest(A = granges_JUM_differential_CDS_regions_proteome.filtered.RNA, 
                                                                                                   B = .x, 
                                                                                                   randomize.function = circularRandomizeRegions,
                                                                                                   evaluate.function = numOverlaps,
                                                                                                   ntimes = 100000, 
...
save(permtest_JUM_diff.CDS.proteome.filtered.RNA_vs_fixed.genomic.biomart, file = paste(results_dir, "permtest_JUM_diff.CDS.proteome.filtered.RNA_vs_fixed.genomic.biomart.Rlist", sep = ""))
# load(file = paste(results_dir, "permtest_JUM_diff.CDS.proteome.filtered.RNA_vs_fixed.genomic.biomart.Rlist", sep = ""))

# permtest: PSI-Sigma (proteome-filtered RNA)
permtest_PSIsigma_diff.CDS.proteome.filtered.RNA_vs_fixed.genomic.biomart <- purrr::map(.x = list_of_granges_biomart_regions_genome.relative, 
                                                                                         .f = ~permTest(A = granges_PSIsigma_differential_CDS_regions_proteome.filtered.RNA, 
                                                                                                        B = .x, 
                                                                                                        randomize.function = circularRandomizeRegions,
                                                                                                        evaluate.function = numOverlaps,
                                                                                                        ntimes = 100000, 
...
save(permtest_PSIsigma_diff.CDS.proteome.filtered.RNA_vs_fixed.genomic.biomart, file = paste(results_dir, "permtest_PSIsigma_diff.CDS.proteome.filtered.RNA_vs_fixed.genomic.biomart.Rlist", sep = ""))
# load(file = paste(results_dir, "permtest_PSIsigma_diff.CDS.proteome.filtered.RNA_vs_fixed.genomic.biomart.Rlist", sep = ""))

```

#### dbPTM regions - loop thru each type of mod.

```{r}

# grange-ify the dbPTM sites
## split by PTM type, unnest the item coords and chr
list_of_tibbles_dbPTM_coords_and_chr <- tibble_dbPTM_allhuman_annotations_cast_onto_genome %>% 
  dplyr::group_split(PTM_type) %>%
  set_names(purrr::map(.x = ., .f = ~.x$PTM_type %>% unique)) %>%
  purrr::map(~.x %>%
               dplyr::select(chr, vec_all_genome_relative_coords_of_item) %>% 
               unnest(cols = "vec_all_genome_relative_coords_of_item") %>% 
               dplyr::filter(is.na(vec_all_genome_relative_coords_of_item) != TRUE) %>%
               dplyr::arrange(vec_all_genome_relative_coords_of_item))

## convert vector of discontinuous sites into chr, start, end.
list_of_tibbles_dbPTM_sites_genome.relative_chr.start.end <- list_of_tibbles_dbPTM_coords_and_chr %>% purrr::map(~convert_vector.of.positions_to_simple.ranges(input_vector = .x$vec_all_genome_relative_coords_of_item, metadata_vector = .x$chr) %>% 
                                                                                                          # rename metadata column)
                                                                                                          dplyr::rename("chr" = "value") %>% 
                                                                                                          # filter out non-1:22/X/Y chromosome entries
                                                                                                          dplyr::filter(chr %in% c(1:22, "X", "Y")))

list_of_granges_dbPTM_sites_genome.relative <- list_of_tibbles_dbPTM_sites_genome.relative_chr.start.end %>% 
  purrr::map(~toGRanges(.x[, c("chr", "start", "end")] %>% 
                          # turn chr column into chr1 chr2 etc...
                          dplyr::mutate_at(.vars = "chr", .funs = function(x) {paste("chr", x, sep = "")} ) %>%
                          type_convert %>% 
...
# permtest: JUM (all RNA)
permtest_JUM_diff.CDS.all.RNA_vs_fixed.genomic.dbPTM <- purrr::map(.x = list_of_granges_dbPTM_sites_genome.relative[c("Ubiquitination", "Phosphorylation", "Acetylation")], 
                                                                      .f = ~permTest(A = granges_JUM_differential_CDS_regions_all.RNA, 
                                                                                     B = .x, 
                                                                                     randomize.function = circularRandomizeRegions,
                                                                                     evaluate.function = numOverlaps,
...
save(permtest_JUM_diff.CDS.all.RNA_vs_fixed.genomic.dbPTM, file = paste(results_dir, "permtest_JUM_diff.CDS.all.RNA_vs_fixed.genomic.dbPTM.Rlist", sep = ""))
load(file = paste(results_dir, "permtest_JUM_diff.CDS.all.RNA_vs_fixed.genomic.dbPTM.Rlist", sep = ""))

# permtest: PSI-Sigma (all RNA)
permtest_PSIsigma_diff.CDS.all.RNA_vs_fixed.genomic.dbPTM <- purrr::map(.x = list_of_granges_dbPTM_sites_genome.relative[c("Ubiquitination", "Phosphorylation", "Acetylation")], 
                                                                           .f = ~permTest(A = granges_PSIsigma_differential_CDS_regions_all.RNA, 
                                                                                          B = .x, 
                                                                                          randomize.function = circularRandomizeRegions,
                                                                                          evaluate.function = numOverlaps,
...
save(permtest_PSIsigma_diff.CDS.all.RNA_vs_fixed.genomic.dbPTM, file = paste(results_dir, "permtest_PSIsigma_diff.CDS.all.RNA_vs_fixed.genomic.dbPTM.Rlist", sep = ""))
load(file = paste(results_dir, "permtest_PSIsigma_diff.CDS.all.RNA_vs_fixed.genomic.dbPTM.Rlist", sep = ""))

# permtest: JUM (proteome-filtered RNA)
permtest_JUM_diff.CDS.proteome.filtered.RNA_vs_fixed.genomic.dbPTM <- purrr::map(.x = list_of_granges_dbPTM_sites_genome.relative[c("Ubiquitination", "Phosphorylation", "Acetylation")], 
                                                                                    .f = ~permTest(A = granges_JUM_differential_CDS_regions_proteome.filtered.RNA, 
                                                                                                   B = .x, 
                                                                                                   randomize.function = circularRandomizeRegions,
                                                                                                   evaluate.function = numOverlaps,
...
save(permtest_JUM_diff.CDS.proteome.filtered.RNA_vs_fixed.genomic.dbPTM, file = paste(results_dir, "permtest_JUM_diff.CDS.proteome.filtered.RNA_vs_fixed.genomic.dbPTM.Rlist", sep = ""))
load(file = paste(results_dir, "permtest_JUM_diff.CDS.proteome.filtered.RNA_vs_fixed.genomic.dbPTM.Rlist", sep = ""))

# permtest: PSI-Sigma (proteome-filtered RNA)
permtest_PSIsigma_diff.CDS.proteome.filtered.RNA_vs_fixed.genomic.dbPTM <- purrr::map(.x = list_of_granges_dbPTM_sites_genome.relative[c("Ubiquitination", "Phosphorylation", "Acetylation")], 
                                                                                         .f = ~permTest(A = granges_PSIsigma_differential_CDS_regions_proteome.filtered.RNA, 
                                                                                                        B = .x, 
                                                                                                        randomize.function = circularRandomizeRegions,
                                                                                                        evaluate.function = numOverlaps,
...
save(permtest_PSIsigma_diff.CDS.proteome.filtered.RNA_vs_fixed.genomic.dbPTM, file = paste(results_dir, "permtest_PSIsigma_diff.CDS.proteome.filtered.RNA_vs_fixed.genomic.dbPTM.Rlist", sep = ""))
load(file = paste(results_dir, "permtest_PSIsigma_diff.CDS.proteome.filtered.RNA_vs_fixed.genomic.dbPTM.Rlist", sep = ""))
...
list_permtest_results_JUM <- purrr::map(.x = tibble_JUM_AS.event.ID_snps_summary_by_trait[1:8, ] %>% .$`DISEASE/TRAIT`, .f = function(.x) {
                                           ...
                                           }) %>% set_names(tibble_JUM_AS.event.ID_snps_summary_by_trait[1:8, ] %>% .$`DISEASE/TRAIT`)

save(list_permtest_results_JUM, file = paste(results_dir, "list_SNP_permtest_results_JUM.Rlist", sep = ""))
...
# use purrr to test significance of all traits simultaneously
list_permtest_results_PSIsigma <- purrr::map(.x = tibble_psisigma_diff.exon.coords_snps_summary_by_trait[1:8, ] %>% .$`DISEASE/TRAIT`, .f = function(.x) {
...
save(list_permtest_results_PSIsigma, file = paste(results_dir, "list_SNP_permtest_results_PSIsigma.Rlist", sep = ""))
