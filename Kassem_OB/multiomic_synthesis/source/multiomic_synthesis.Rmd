...
ggplot(data = tibble_combined_biomart_RNAlevel, aes(x = `interpro_description`, y = tally, fill = tool)) +
  ...
  ylim(c(0, tibble_combined_biomart_RNAlevel$tally %>% max * 1.2)) +
  ...
  ggsave(filename = paste(results_dir, "tibble_combined_biomart_RNAlevel_with_bootstrap_significance.pdf", sep = ""), device = "pdf", dpi = 600, width = 12, height = 10, units = "cm") +
  ggsave(filename = paste(results_dir, "tibble_combined_biomart_RNAlevel_with_bootstrap_significance.svg", sep = ""), device = "svg", dpi = 600, width = 12, height = 10, units = "cm")
...
ggplot(data = tibble_combined_PTMs_RNAlevel, aes(x = `PTM_type`, y = tally, fill = tool)) +
  ...
  # geom_text(stat = "identity", aes(y = tally + 10 + ((floor(tally %>% log10) + 1) * 12.5), label = significant %>% (function(x) {y <- x; y[y == TRUE] <- "*"; y[y == FALSE] <- ""; return(y) } )) , position = position_dodge(width = 1), vjust = 0.8, size = 8, colour = "forestgreen") +
  scale_x_discrete(labels = function(x) str_wrap(x, width = 25)) +
  ylim(c(0, tibble_combined_PTMs_RNAlevel$tally %>% max(na.rm = TRUE) * 1.2)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(hjust = 1, colour = "black", angle = 45), legend.title.align = 0.5, legend.background = element_rect(size = 0.5, linetype = "solid", colour = "black"), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family = "Helvetica")) +
  ggsave(filename = paste(results_dir, "tibble_combined_PTM_RNAlevel_with_bootstrap_significance.pdf", sep = ""), device = "pdf", dpi = 600, width = 10, height = 6, units = "cm") +
  ggsave(filename = paste(results_dir, "tibble_combined_PTM_RNAlevel_with_bootstrap_significance.svg", sep = ""), device = "svg", dpi = 600, width = 10, height = 6, units = "cm")
...
ggplot(data = tibble_combined_biomart_RNAlevel_filtered_by_proteome, aes(x = `interpro_description`, y = tally, fill = tool)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(hjust = 1, colour = "black", angle = 45), legend.title.align = 0.5, legend.background = element_rect(size = 0.5, linetype = "solid", colour = "black"), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family = "Helvetica")) +
  ggsave(filename = paste(results_dir, "tibble_combined_biomart_RNAlevel_filtered_by_proteome_with_bootstrap_significance.pdf", sep = ""), device = "pdf", dpi = 600, width = 12, height = 10, units = "cm") +
  ggsave(filename = paste(results_dir, "tibble_combined_biomart_RNAlevel_filtered_by_proteome_with_bootstrap_significance.svg", sep = ""), device = "svg", dpi = 600, width = 12, height = 10, units = "cm")
...
ggplot(data = tibble_combined_PTMs_RNAlevel_filtered_by_proteome, aes(x = `PTM_type`, y = tally, fill = tool)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(hjust = 1, colour = "black", angle = 45), legend.title.align = 0.5, legend.background = element_rect(size = 0.5, linetype = "solid", colour = "black"), axis.title.y = element_text(margin = margin(r = 20)), text = element_text(family = "Helvetica")) +
  ggsave(filename = paste(results_dir, "tibble_combined_PTM_RNAlevel_filtered_by_proteome_with_bootstrap_significance.pdf", sep = ""), device = "pdf", dpi = 600, width = 10, height = 6, units = "cm") +
  ggsave(filename = paste(results_dir, "tibble_combined_PTM_RNAlevel_filtered_by_proteome_with_bootstrap_significance.svg", sep = ""), device = "svg", dpi = 600, width = 10, height = 6, units = "cm")
...
#### construction of the effective exome
...
#### cast dbPTM sites onto the genome, convert to CDS-relative topology, then convert to granges.
...
#### biomarts regions - loop thru each type of region - **CDSome**
...
## L2: biomart region
## NOTE: we do not need to filter by proteome for the exome.
list_permtest_CDS_biomart_regions <- future_map(
  .x = list_granges_CDS_differential_positions, 
  .f = function(a1) {
    
    # DEBUG ###
    # a1 <- list_granges_CDS_differential_positions[[1]]
    ###########
    
    list_result <- future_map(
      .x = list_granges_biomart_regions_CDS_relative,
      .f = function(b1) {
        
        # DEBUG ###
        # b1 <- list_granges_biomart_regions_CDS_relative[[1]]
        ###########
        ...
        regioneR::permTest(A = a1,
                           ...
                           evaluate.function = numOverlaps,
                           ntimes = 10000,
                           genome = granges_effective_CDSome,
                           # min.parallel = 8,
                           alternative = "greater",
                           force.parallel = TRUE,
                           verbose = TRUE,
...
save(list_permtest_CDS_biomart_regions, file = paste(results_dir, "list_permtest_CDS_biomart_regions.Rlist", sep = ""))

```

#### PTMs - loop thru each type of PTM - **CDSome**
...
## L2: biomart region
## NOTE: we do not need to filter by proteome for the exome.
list_permtest_CDS_PTMs <- future_map(
  .x = list_granges_CDS_differential_positions, 
  .f = function(a1) {
    ...
    list_result <- future_map(
      .x = list_granges_PTM_sites_CDS_relative,
      .f = function(b1) {
        
        # DEBUG ###
        # b1 <- list_granges_PTM_sites_CDS_relative[[1]]
        ###########
...
save(list_permtest_CDS_PTMs, file = paste(results_dir, "list_permtest_CDS_PTMs.Rlist", sep = ""))
