...
SRSF11 (DS 6, 7, 8, 10, 12): CIRBP, HNRNPA2B1, HNRNPH1, RBM6/25/39, SFPQ, SRRM2, SRSF2, U2AF1L4
...
list_JUM_PSIsigma_combined_diff_coordinate_level_clip_seq_geneset_targets_and_GOterms <- future_pmap(
  .l = list(
    ...
    "a2" = list(
      ...
      "JUM_and_PSIsigma_differential|SRSF2 FLASH GSE118265" = c(3, 6),
      "JUM_and_PSIsigma_differential|SRSF3 FLASH GSE118265" = c(2, 4),
      "JUM_and_PSIsigma_differential|SRSF5 FLASH GSE118265" = c(1, 7),
      "JUM_and_PSIsigma_differential|SRSF6 FLASH GSE118265" = c(1, 2, 4, 7),
      "JUM_and_PSIsigma_differential|SRSF11 FLASH GSE118265" = c(6, 7, 8, 10, 12),
      "JUM_and_PSIsigma_differential|HNRNPA1 eCLIP ENCODE" = c(4),
      "JUM_and_PSIsigma_differential|HNRNPA2B1 HITS-CLIP GSM1716538" = c(6),
      "JUM_and_PSIsigma_differential|MBNL1 HITS-CLIP GSE76486" = c(1, 2, 6, 7),
      "JUM_and_PSIsigma_differential|PRPF4 eCLIP ENCODE" = c(6),
      # "JUM_and_PSIsigma_differential|RBM15 eCLIP ENCODE" = c(6),
      "JUM_and_PSIsigma_differential|SFPQ eCLIP ENCODE" = c(6),
      "JUM_and_PSIsigma_differential|SUGP2 eCLIP ENCODE" = c(3, 2, 6, 12, 14),
      "JUM_and_PSIsigma_differential|TRA2A eCLIP ENCODE" = c(1, 4),
