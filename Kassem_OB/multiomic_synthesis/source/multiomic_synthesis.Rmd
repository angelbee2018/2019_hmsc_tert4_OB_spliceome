...
list_psisigma_differential_with_na_matched_to_ont <- round_robin_pmap_callr(
  ...
  .chunkify = TRUE,
  .no_chunks = 99,
  .temp_path = "/mnt/scratch/temp/PEF_2019_multiomic_synthesis_list_psisigma_differential_with_na_matched_to_ont.rdata",
  .temp_dir = "/mnt/scratch/temp/",
  .re_export = TRUE,
  .env_flag = "user",
  .objects = c("tibble_2023_hmsc_ob_ont_gtf"),
  .status_messages_dir = "/mnt/scratch/temp/",
  .job_name = "PEF_2019_multiomic_synthesis_list_psisigma_differential_with_na_matched_to_ont",
  .result_mode = "ordered",
...
saveRDS(object = list_psisigma_differential_with_na_matched_to_ont, file = paste(results_dir, "list_psisigma_differential_with_na_matched_to_ont.rds", sep = ""))
...
list_psisigma_constitutive_matched_to_ont
list_jum_differential_with_na_matched_to_ont
list_jum_constitutive_no_na_matched_to_ont
list_majiq_differential_with_na_matched_to_ont
list_majiq_constitutive_matched_to_ont
