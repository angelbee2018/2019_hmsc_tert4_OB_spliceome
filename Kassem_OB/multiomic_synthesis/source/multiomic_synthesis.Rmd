...
list_permtest_results_JUM_differential_traits <- purrr::map(.x = tibble_JUM_differential_AS.event.ID_snps_summary_by_trait[1:8, ] %>% .$`DISEASE/TRAIT`, .f = function(.x) {
                                             ...
                                             # grange-ify 
                                             granges_items_chr_start_end <- toGRanges(tibble_AS.event.IDs_chr_start_end_differential[, c("chr", "start", "end", "strand")] %>% 
                                                                                        # remove MT ranges
                                                                                        dplyr::filter(chr != "MT", .preserve = TRUE) %>%
                                                                                        # turn chr column into chr1 chr2 etc...
                                                                                        dplyr::mutate_at(.vars = "chr", .funs = function(x) {paste("chr", x, sep = "")} ) %>%
...
# use purrr to test significance of all traits simultaneously
list_permtest_results_JUM_constitutive_traits <- purrr::map(.x = tibble_JUM_constitutive_AS.event.ID_snps_summary_by_trait[1:8, ] %>% .$`DISEASE/TRAIT`, .f = function(.x) {
                                             ...
                                             # grange-ify 
                                             granges_items_chr_start_end <- toGRanges(tibble_AS.event.IDs_chr_start_end_constitutive[, c("chr", "start", "end", "strand")] %>% 
                                                                                        # remove MT ranges
                                                                                        dplyr::filter(chr != "MT", .preserve = TRUE) %>%
                                                                                        # turn chr column into chr1 chr2 etc...
                                                                                        dplyr::mutate_at(.vars = "chr", .funs = function(x) {paste("chr", x, sep = "")} ) %>%
...
# use purrr to test significance of all traits simultaneously
list_permtest_results_PSIsigma_differential_traits <- purrr::map(.x = tibble_psisigma_differential_snps_summary_by_trait[1:8, ] %>% .$`DISEASE/TRAIT`, .f = function(.x) {
...
# use purrr to test significance of all traits simultaneously
list_permtest_results_PSIsigma_constitutive_traits <- purrr::map(.x = tibble_psisigma_constitutive_snps_summary_by_trait[1:8, ] %>% .$`DISEASE/TRAIT`, .f = function(.x) {
...
long_tibble_combined_traits <- list(tibble_JUM_differential_AS.event.ID_snps_summary_by_trait, 
...
long_tibble_combined_contexts <- list(tibble_JUM_differential_AS.event.ID_snps_summary_by_context, 
...
ggplot(data = long_tibble_combined_traits, aes(x = `DISEASE/TRAIT`, y = tally, fill = tool_diff.cons)) +
  ...
  scale_fill_manual(name = "Tool", 
                    breaks = c("trait_tally_JUM_differential", "trait_tally_JUM_constitutive", "trait_tally_PSIsigma_differential", "trait_tally_PSIsigma_constitutive"), 
                    limits = c("trait_tally_JUM_differential", "trait_tally_JUM_constitutive", "trait_tally_PSIsigma_differential", "trait_tally_PSIsigma_constitutive"), 
                    labels = c("JUM", "JUM", "PSI-Sigma", "PSI-Sigma"), 
                    values = c("purple3", "purple3", "firebrick4", "firebrick4")) +
  scale_x_discrete(labels = function(x) str_wrap(x, width = 25)) +
  ylim(c(0, wide_tibble_combined_traits$tally %>% max * 1.1)) +
...
ggplot(data = long_tibble_combined_contexts, aes(x = `CONTEXT`, y = tally, fill = tool_diff.cons)) +
  geom_col_pattern(position = "dodge", aes(pattern = tool_diff.cons), pattern_spacing = 0.01, pattern_density = 0.1, pattern_colour = "white", size = 0.2, colour = "black") +
  scale_pattern_discrete(name = "Data series", 
  ...
  ylim(c(0, wide_tibble_combined_contexts$tally %>% max * 1.25)) +
