...
# R_processing_results_dir <- paste("Y:/sharedfolder/PGNEXUS_kassem_MSC/Kassem_OB/phosphoproteomic_analysis/analysis_maxquant/results/R_processing_results/", sep = "")
...
}, .progress = TRUE, .options = future_options(globals = c("filter_less_than_x_na_for_all_timepoints", "dplyr")) )
...
list_of_eigenMS_results_DreamAI_imputed_sp <- future_map2(.x = list_of_eigenMS_results_filtered_less_than_1_na_all_timepoints[c("sp.hsa.canonical.isoforms_junc.exons", "con_sp.hsa.canonical.isoforms", "con_sp.hsa.canonical.isoforms_trembl")], 
                                                          ...
                                                          .f = function(a1, a2) {
                                                            ...
                                                            L2_list <- future_map2(.x = a1, .y = names(a1), .f = function(b1, b2) {
                                                              ...
                                                              list_imputed_dataframe <- DreamAI(b1$result_table %>% dplyr::select(-id) %>% as.matrix, k = 10, maxiter_MF = 10, ntree = 100,
                                                            ...
                                                            }, .progress = TRUE, .options = future_options(globals = c("DreamAI", "dplyr", "plot_PCA_for_timepoint_and_replicate", "tibble", "impute.knn", "R_processing_results_dir", "ggplot2", "ggplot", "vector_replicate_names")) )
                                                            
                                                            return(L2_list)
                                                            
                                                          }, .progress = TRUE, .options = future_options(globals = c("DreamAI", "dplyr", "plot_PCA_for_timepoint_and_replicate", "tibble", "impute.knn", "R_processing_results_dir", "ggplot2", "ggplot", "vector_replicate_names")) )

save.image(file = paste(R_processing_results_dir, "02102020_windows_dreamAI.Rdata"))
...
list_GOhyper_enrichment <- purrr::pmap(.l = list(
  "a1" = list_eigenMS_limma_results_geneset,
  "a2" = names(list_eigenMS_limma_results_geneset)), .f = function(a1, a2) {
