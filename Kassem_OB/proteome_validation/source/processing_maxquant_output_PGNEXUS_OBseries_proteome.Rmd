...
tibble_junctions_3FT_info <- read.delim("Z:/PGNEXUS_kassem_MSC/Kassem_OB/proteome_validation/three_frame_translation_results/threeframetranslate_junctions_qvalue0.01_dpsi0.15_diff_3FT.summary.info.txt", sep = "\t", stringsAsFactors =  FALSE, row.names = NULL, header = TRUE) %>% as_tibble
